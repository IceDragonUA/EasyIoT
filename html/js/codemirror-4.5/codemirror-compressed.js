/* CodeMirror - Minified & Bundled
 Generated on 8/26/2014 with http://codemirror.net/doc/compress.html
 Version: 4.5
...
!function (a) {
    ...
    function w(a, b) {
        ...
        this.options = b = b || {}, Pg(je, b, !1), K(b);
        var c = b.value;
        "string" == typeof c && (c = new Kf(c, b.mode)), this.doc = c;
        var f = this.display = new x(a, c);
        f.wrapper.CodeMirror = this, G(this), E(this), b.lineWrapping && (this.display.wrapper.className += " CodeMirror-wrap"), b.autofocus && !o && ad(this), this.state = {
            keyMaps: [],
            overlays: [],
            modeGen: 0,
            overwrite: !1,
            ...
            draggingText: !1,
            highlight: new Fg
        }, d && 11 > e && setTimeout(Qg(_c, this, !0), 20), dd(this), hh();
        var g = this;
        Kc(this, function () {
            g.curOp.forceUpdate = !0, Of(g, c), b.autofocus && !o || ah() == f.input ? setTimeout(Qg(Hd, g), 20) : Id(g);
            for (var a in ke)ke.hasOwnProperty(a) && ke[a](g, b[a], me);
            Q(g);
            for (var d = 0; d < qe.length; ++d)qe[d](g)
        })
    }

    function x(a, b) {
        var c = this, g = c.input = Xg("textarea", null, null, "position: absolute; padding: 0; width: 1px; height: 1em; outline: none");
    ...
    function z(a) {
        ...
        }), a.doc.frontier = a.doc.first, Ub(a, 100), a.state.modeGen++, a.curOp && Qc(a)
    }

    function A(a) {
        a.options.lineWrapping ? (dh(a.display.wrapper, "CodeMirror-wrap"), a.display.sizer.style.minWidth = "") : (ch(a.display.wrapper, "CodeMirror-wrap"), J(a)), C(a), Qc(a), lc(a), setTimeout(function () {
            N(a)
        }, 100)
    }

    function B(a) {
        var b = xc(a.display), c = a.options.lineWrapping, d = c && Math.max(5, a.display.scroller.clientWidth / yc(a.display) - 3);
        return function (e) {
            if (ef(a.doc, e))return 0;
            var f = 0;
    ...
    function D(a) {
        var b = ve[a.options.keyMap], c = b.style;
        a.display.wrapper.className = a.display.wrapper.className.replace(/\s*cm-keymap-\S+/g, "") + (c ? " cm-keymap-" + c : "")
    }

    function E(a) {
        a.display.wrapper.className = a.display.wrapper.className.replace(/\s*cm-s-\S+/g, "") + a.options.theme.replace(/(^|\s)\s*/g, " cm-s-"), lc(a)
    }

    function F(a) {
        G(a), Qc(a), setTimeout(function () {
            P(a)
        }, 20)
    }
    ...
    function G(a) {
        ...
        for (var d = 0; d < c.length; ++d) {
            var e = c[d], f = b.appendChild(Xg("div", null, "CodeMirror-gutter " + e));
    ...
    function I(a) {
        ...
        for (var c, b = a.text.length, d = a; c = Ze(d);) {
            var e = c.find(0, !0);
    ...
    function J(a) {
        ...
        b.maxLine = Pf(c, c.first), b.maxLineLength = I(b.maxLine), b.maxLineChanged = !0, c.iter(function (a) {
            var c = I(a);
    ...
    function K(a) {
        var b = Mg(a.gutters, "CodeMirror-linenumbers");
    ...
    function L(a) {
        return a.display.scroller.clientHeight - a.display.wrapper.clientHeight < Ag - 3
    }
    ...
    function N(a, b) {
        b || (b = M(a));
        var c = a.display, d = lh(c.measure), e = b.docHeight + Ag, f = b.scrollWidth > b.clientWidth;
        ...
        if (g ? (c.scrollbarV.style.display = "block", c.scrollbarV.style.bottom = f ? d + "px" : "0", c.scrollbarV.firstChild.style.height = Math.max(0, e - b.clientHeight + (b.barHeight || c.scrollbarV.clientHeight)) + "px") : (c.scrollbarV.style.display = "", c.scrollbarV.firstChild.style.height = "0"), f ? (c.scrollbarH.style.display = "block", c.scrollbarH.style.right = g ? d + "px" : "0", c.scrollbarH.firstChild.style.width = b.scrollWidth - b.clientWidth + (b.barWidth || c.scrollbarH.clientWidth) + "px") : (c.scrollbarH.style.display = "", c.scrollbarH.firstChild.style.width = "0"), f && g ? (c.scrollbarFiller.style.display = "block", c.scrollbarFiller.style.height = c.scrollbarFiller.style.width = d + "px") : c.scrollbarFiller.style.display = "", f && a.options.coverGutterNextToScrollbar && a.options.fixedGutter ? (c.gutterFiller.style.display = "block", c.gutterFiller.style.height = d + "px", c.gutterFiller.style.width = c.gutters.offsetWidth + "px") : c.gutterFiller.style.display = "", !a.state.checkedOverlayScrollbar && b.clientHeight > 0) {
            if (0 === d) {
                ...
                var i = function (b) {
                    og(b) != c.scrollbarV && og(b) != c.scrollbarH && Lc(a, hd)(b)
                };
                qg(c.scrollbarV, "mousedown", i), qg(c.scrollbarH, "mousedown", i)
            }
    ...
    function O(a, b, c) {
        ...
        d = Math.floor(d - Yb(a));
        var e = c && null != c.bottom ? c.bottom : d + a.wrapper.clientHeight, f = Uf(b, d), g = Uf(b, e);
        if (c && c.ensure) {
            var h = c.ensure.from.line, i = c.ensure.to.line;
            if (f > h)return {from: h, to: Uf(b, Vf(Pf(b, h)) + a.wrapper.clientHeight)};
            if (Math.min(i, b.lastLine()) >= g)return {from: Uf(b, Vf(Pf(b, i)) - a.wrapper.clientHeight), to: i}
        }
    ...
    function Q(a) {
        ...
        if (c.length != d.lineNumChars) {
            var e = d.measure.appendChild(Xg("div", [Xg("div", c)], "CodeMirror-linenumber CodeMirror-gutter-elt")), f = e.firstChild.offsetWidth, g = e.offsetWidth - f;
    ...
    function U(a, b) {
        ...
        if (!b.force && b.visible.from >= c.viewFrom && b.visible.to <= c.viewTo && (null == c.updateLineNumbers || c.updateLineNumbers >= c.viewTo) && 0 == Wc(a))return !1;
        Q(a) && (Sc(a), b.dims = _(a));
        ...
        c.viewFrom < f && f - c.viewFrom < 20 && (f = Math.max(d.first, c.viewFrom)), c.viewTo > g && c.viewTo - g < 20 && (g = Math.min(e, c.viewTo)), v && (f = cf(a.doc, f), g = df(a.doc, g));
        var h = f != c.viewFrom || g != c.viewTo || c.lastSizeC != b.wrapperHeight;
        Vc(a, f, g), c.viewOffset = Vf(Pf(a.doc, c.viewFrom)), a.display.mover.style.top = c.viewOffset + "px";
        var i = Wc(a);
        if (!h && 0 == i && !b.force && (null == c.updateLineNumbers || c.updateLineNumbers >= c.viewTo))return !1;
        var j = ah();
        return i > 4 && (c.lineDiv.style.display = "none"), ab(a, c.updateLineNumbers, b.dims), i > 4 && (c.lineDiv.style.display = ""), j && ah() != j && j.offsetHeight && j.focus(), Zg(c.cursorDiv), Zg(c.selectionDiv), h && (c.lastSizeC = b.wrapperHeight, Ub(a, 400)), c.updateLineNumbers = null, !0
    }

    function V(a, b) {
        for (var c = b.force, d = b.viewport, e = !0; ; e = !1) {
            if (e && a.options.lineWrapping && b.oldScrollerWidth != a.display.scroller.clientWidth) c = !0; else if (c = !1, d && null != d.top && (d = {top: Math.min(a.doc.height + Zb(a.display) - Ag - a.display.scroller.clientHeight, d.top)}), b.visible = O(a.display, a.doc, d), b.visible.from >= a.display.viewFrom && b.visible.to <= a.display.viewTo)break;
            if (!U(a, b))break;
            Z(a);
            var f = M(a);
            Qb(a), X(a, f), N(a, f)
        }
        ug(a, "update", a), (a.display.viewFrom != b.oldViewFrom || a.display.viewTo != b.oldViewTo) && ug(a, "viewportChange", a, a.display.viewFrom, a.display.viewTo)
    }
    ...
    function X(a, b) {
        a.display.sizer.style.minHeight = a.display.heightForcer.style.top = b.docHeight + "px", a.display.gutters.style.height = Math.max(b.docHeight, b.clientHeight - Ag) + "px"
    }
    ...
    function Z(a) {
        for (var b = a.display, c = b.lineDiv.offsetTop, f = 0; f < b.view.length; f++) {
            ...
            if (!g.hidden) {
                ...
                if (2 > h && (h = xc(b)), (k > .001 || -.001 > k) && (Sf(g.line, h), $(g.line), g.rest))for (var l = 0; l < g.rest.length; l++)$(g.rest[l])
            }
        }
    }
    ...
    function ab(a, b, c) {
        ...
        for (var d = a.display, e = a.options.lineNumbers, g = d.lineDiv, h = g.firstChild, j = d.view, k = d.viewFrom, l = 0; l < j.length; l++) {
            ...
            if (m.hidden); else if (m.node) {
                ...
                m.changes && (Mg(m.changes, "gutter") > -1 && (o = !1), bb(a, m, k, c)), o && (Zg(m.lineNumber), m.lineNumber.appendChild(document.createTextNode(R(a.options, k)))), h = m.node.nextSibling
            } else {
                var n = jb(a, m, k, c);
                g.insertBefore(n, h)
            }
    ...
    function cb(a) {
        return a.node == a.text && (a.node = Xg("div", null, null, "position: relative"), a.text.parentNode && a.text.parentNode.replaceChild(a.node, a.text), a.node.appendChild(a.text), d && 8 > e && (a.node.style.zIndex = 2)), a.node
    }
    ...
    function db(a) {
        ...
        if (b && (b += " CodeMirror-linebackground"), a.background) b ? a.background.className = b : (a.background.parentNode.removeChild(a.background), a.background = null); else if (b) {
            var c = cb(a);
            a.background = c.insertBefore(Xg("div", null, b), c.firstChild)
        }
    }

    function eb(a, b) {
        var c = a.display.externalMeasured;
        return c && c.line == b.line ? (a.display.externalMeasured = null, b.measure = c.measure, c.built) : yf(a, b)
    }
    ...
    function hb(a, b, c, d) {
        ...
        if (a.options.lineNumbers || e) {
            var f = cb(b), g = b.gutter = f.insertBefore(Xg("div", null, "CodeMirror-gutter-wrapper", "position: absolute; left: " + (a.options.fixedGutter ? d.fixedPos : -d.gutterTotalWidth) + "px"), b.text);
            if (!a.options.lineNumbers || e && e["CodeMirror-linenumbers"] || (b.lineNumber = g.appendChild(Xg("div", R(a.options, c), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + d.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + a.display.lineNumInnerWidth + "px"))), e)for (var h = 0; h < a.options.gutters.length; ++h) {
                var i = a.options.gutters[h], j = e.hasOwnProperty(i) && e[i];
                j && g.appendChild(Xg("div", [j], "CodeMirror-gutter-elt", "left: " + d.gutterLeft[i] + "px; width: " + d.gutterWidth[i] + "px"))
            }
        }
    }
    ...
    function lb(a, b, c, d) {
        if (a.widgets)for (var e = cb(b), f = 0, g = a.widgets; f < g.length; ++f) {
            var h = g[f], i = Xg("div", [h.node], "CodeMirror-linewidget");
            h.handleMouseEvents || (i.ignoreEvents = !0), mb(h, i, b, c), d && h.above ? e.insertBefore(i, b.gutter || b.text) : e.appendChild(i), ug(h, "redraw")
        }
    }
    ...
    function xb(a, b) {
        ...
        return b.line > c ? nb(c, Pf(a, c).text.length) : yb(b, Pf(a, b.line).text.length)
    }
    ...
    function Gb(a, b) {
        ...
        return sg(a, "beforeSelectionChange", a, c), a.cm && sg(a.cm, "beforeSelectionChange", a.cm, c), c.ranges != b.ranges ? ub(c.ranges, c.ranges.length - 1) : b
    }

    function Hb(a, b, c) {
        var d = a.history.done, e = Kg(d);
        e && e.ranges ? (d[d.length - 1] = b, Jb(a, b, c)) : Ib(a, b, c)
    }

    function Ib(a, b, c) {
        Jb(a, b, c), bg(a, a.sel, a.cm ? a.cm.curOp.id : 0 / 0, c)
    }

    function Jb(a, b, c) {
        (yg(a, "beforeSelectionChange") || a.cm && yg(a.cm, "beforeSelectionChange")) && (b = Gb(a, b));
        var d = c && c.bias || (ob(b.primary().head, a.sel.primary().head) < 0 ? -1 : 1);
        Kb(a, Mb(a, b, d, !0)), c && c.scroll === !1 || !a.cm || be(a.cm)
    }

    function Kb(a, b) {
        b.equals(a.sel) || (a.sel = b, a.cm && (a.cm.curOp.updateInput = a.cm.curOp.selectionChanged = !0, xg(a.cm)), ug(a, "cursorActivity", a))
    }

    function Lb(a) {
        Kb(a, Mb(a, a.sel, null, !1), Cg)
    }
        ...
        a:for (; ;) {
            ...
            if (h.markedSpans)for (var i = 0; i < h.markedSpans.length; ++i) {
                ...
                if ((null == j.from || (k.inclusiveLeft ? j.from <= f.ch : j.from < f.ch)) && (null == j.to || (k.inclusiveRight ? j.to >= f.ch : j.to > f.ch))) {
                    if (d && (sg(k, "beforeCursorEnter"), k.explicitlyCleared)) {
                        if (h.markedSpans) {
                            --i;
                            continue
                        }
    ...
    function Ob(a) {
        ...
        if (a.options.moveInputWithCursor) {
            var j = rc(a, c.sel.primary().head, "div"), k = b.wrapper.getBoundingClientRect(), l = b.lineDiv.getBoundingClientRect();
    ...
    function Pb(a, b) {
        $g(a.display.cursorDiv, b.cursors), $g(a.display.selectionDiv, b.selection), null != b.teTop && (a.display.inputDiv.style.top = b.teTop + "px", a.display.inputDiv.style.left = b.teLeft + "px")
    }
    ...
    function Rb(a, b, c) {
        var d = rc(a, b.head, "div", null, null, !a.options.singleCursorHeightPerLine), e = c.appendChild(Xg("div", "\xa0", "CodeMirror-cursor"));
        if (e.style.left = d.left + "px", e.style.top = d.top + "px", e.style.height = Math.max(0, d.bottom - d.top) * a.options.cursorHeight + "px", d.other) {
            var f = c.appendChild(Xg("div", "\xa0", "CodeMirror-cursor CodeMirror-secondarycursor"));
    ...
    function Sb(a, b, c) {
        function j(a, b, c, d) {
            0 > b && (b = 0), b = Math.round(b), d = Math.round(d), f.appendChild(Xg("div", null, "CodeMirror-selected", "position: absolute; left: " + a + "px; top: " + b + "px; width: " + (null == c ? i - a : c) + "px; height: " + (d - b) + "px"))
        }
        ...
        function k(b, c, d) {
            ...
            var k, l, f = Pf(e, b), g = f.text.length;
            return wh(Wf(f), c || 0, null == d ? g : d, function (a, b, e) {
        ...
        var d = a.display, e = a.doc, f = document.createDocumentFragment(), g = $b(a.display), h = g.left, i = d.lineSpace.offsetWidth - g.right, l = b.from(), m = b.to();
        if (l.line == m.line) k(l.line, l.ch, m.ch); else {
            var n = Pf(e, l.line), o = Pf(e, m.line), p = af(n) == af(o), q = k(l.line, l.ch, p ? n.text.length + 1 : null).end, r = k(m.line, p ? 0 : null, m.ch).start;
    ...
    function Ub(a, b) {
        a.doc.mode.startState && a.doc.frontier < a.display.viewTo && a.state.highlight.set(b, Qg(Vb, a))
    }

    function Vb(a) {
        var b = a.doc;
        if (b.frontier < b.first && (b.frontier = b.first), !(b.frontier >= a.display.viewTo)) {
            var c = +new Date + a.options.workTime, d = se(b.mode, Xb(a, b.frontier)), e = [];
            b.iter(b.frontier, Math.min(b.first + b.size, a.display.viewTo + 500), function (f) {
                if (b.frontier >= a.display.viewFrom) {
                    var g = f.styles, h = sf(a, f, d, !0);
                    f.styles = h.styles;
                    ...
                    k && e.push(b.frontier), f.stateAfter = se(b.mode, d)
                } else uf(a, f.text, d), f.stateAfter = 0 == b.frontier % 5 ? se(b.mode, d) : null;
                return ++b.frontier, +new Date > c ? (Ub(a, a.options.workDelay), !0) : void 0
            }), e.length && Kc(a, function () {
    ...
    function Xb(a, b, c) {
        ...
        var f = Wb(a, b, c), g = f > d.first && Pf(d, f - 1).stateAfter;
        return g = g ? se(d.mode, g) : te(d.mode), d.iter(f, b, function (c) {
            uf(a, c.text, g);
            var h = f == b - 1 || 0 == f % 5 || f >= e.viewFrom && f < e.viewTo;
            c.stateAfter = h ? se(d.mode, g) : null, ++f
        }), c && (d.frontier = f), g
    }
    ...
    function $b(a) {
        ...
        var b = $g(a.measure, Xg("pre", "x")), c = window.getComputedStyle ? window.getComputedStyle(b) : b.currentStyle, d = {
    ...
    function ac(a, b, c) {
        ...
        for (var d = 0; d < a.rest.length; d++)if (Tf(a.rest[d]) > c)return {
            map: a.measure.maps[d],
            cache: a.measure.caches[d],
            before: !0
        }
    ...
    function bc(a, b) {
        b = af(b);
        var c = Tf(b), d = a.display.externalMeasured = new Oc(a.doc, b, c);
        d.lineN = c;
        var e = d.built = yf(a, d);
        return d.text = e.pre, $g(a.display.lineMeasure, e.pre), d
    }
    ...
    function dc(a, b) {
        if (b >= a.display.viewFrom && b < a.display.viewTo)return a.display.view[Tc(a, b)];
        var c = a.display.externalMeasured;
    ...
    function ec(a, b) {
        var c = Tf(b), d = dc(a, c);
        d && !d.text ? d = null : d && d.changes && bb(a, d, c, _(a)), d || (d = bc(a, b));
        var e = ac(d, b, c);
    ...
    function fc(a, b, c, d, e) {
        b.before && (c = -1);
        var g, f = c + (d || "");
        return b.cache.hasOwnProperty(f) ? g = b.cache[f] : (b.rect || (b.rect = b.view.text.getBoundingClientRect()), b.hasHeights || (_b(a, b.view, b.rect), b.hasHeights = !0), g = hc(a, b, c, d), g.bogus || (b.cache[f] = g)), {
            left: g.left,
            right: g.right,
            top: e ? g.rtop : g.top,
    ...
    function hc(a, b, c, f) {
        ...
        var o;
        if (3 == h.nodeType)for (; ;) {
            for (; i && Wg(b.line.text.charAt(m + i));)--i;
            for (; n > m + j && Wg(b.line.text.charAt(m + j));)++j;
            if (d && 9 > e && 0 == i && j == n - m) o = h.parentNode.getBoundingClientRect(); else if (d && a.options.lineWrapping) {
                var p = Yg(h, i, j).getClientRects();
                o = p.length ? p["right" == f ? p.length - 1 : 0] : gc
            } else o = Yg(h, i, j).getBoundingClientRect() || gc;
        ...
        if (d && 9 > e && !i && (!o || !o.left && !o.right)) {
            ...
            o = q ? {left: q.left, right: q.left + yc(a.display), top: q.top, bottom: q.bottom} : gc
        }
    ...
    function ic(a, b) {
        if (!window.screen || null == screen.logicalXDPI || screen.logicalXDPI == screen.deviceXDPI || !uh(a))return b;
    ...
    function kc(a) {
        a.display.externalMeasure = null, Zg(a.display.lineMeasure);
        for (var b = 0; b < a.display.view.length; b++)jc(a.display.view[b])
    }

    function lc(a) {
        kc(a), a.display.cachedCharWidth = a.display.cachedTextHeight = a.display.cachedPaddingH = null, a.options.lineWrapping || (a.display.maxLineChanged = !0), a.display.lineNumChars = null
    }
    ...
    function oc(a, b, c, d) {
        if (b.widgets)for (var e = 0; e < b.widgets.length; ++e)if (b.widgets[e].above) {
            var f = jf(b.widgets[e]);
            c.top += f, c.bottom += f
        }
        if ("line" == d)return c;
        d || (d = "local");
        var g = Vf(b);
        if ("local" == d ? g += Yb(a.display) : g -= a.display.viewOffset, "page" == d || "window" == d) {
    ...
    function pc(a, b, c) {
        ...
        if ("page" == c) d -= mc(), e -= nc(); else if ("local" == c || !c) {
    ...
    function qc(a, b, c, d, e) {
        return d || (d = Pf(a.doc, b.line)), oc(a, d, cc(a, d, b.ch, e), c)
    }
    ...
    function rc(a, b, c, d, e, f) {
        ...
        function h(a, b) {
            ...
            return a == xh(c) && b && c.level < i[b - 1].level ? (c = i[--b], a = yh(c) - (c.level % 2 ? 0 : 1), d = !0) : a == yh(c) && b < i.length - 1 && c.level < i[b + 1].level && (c = i[++b], a = xh(c) - c.level % 2, d = !1), d && a == c.to && a > c.from ? g(a - 1) : g(a, d)
        }

        d = d || Pf(a.doc, b.line), e || (e = ec(a, d));
        var i = Wf(d), j = b.ch;
        if (!i)return g(j);
        var k = Gh(i, j), l = h(j, k);
        return null != Fh && (l.other = h(j, Fh)), l
    }

    function sc(a, b) {
        var c = 0, b = xb(a.doc, b);
        a.options.lineWrapping || (c = yc(a.display) * b.ch);
        var d = Pf(a.doc, b.line), e = Vf(d) + Yb(a.display);
    ...
    function uc(a, b, c) {
        ...
        var e = Uf(d, c), f = d.first + d.size - 1;
        if (e > f)return tc(d.first + d.size - 1, Pf(d, f).text.length, !0, 1);
        0 > b && (b = 0);
        for (var g = Pf(d, e); ;) {
            var h = vc(a, g, e, b, c), i = $e(g), j = i && i.find(0, !0);
    ...
    function vc(a, b, c, d, e) {
        ...
        var f = e - Vf(b), g = !1, h = 2 * a.display.wrapper.clientWidth, i = ec(a, b), k = Wf(b), l = b.text.length, m = zh(b), n = Ah(b), o = j(m), p = g, q = j(n), r = g;
        if (d > q)return tc(c, n, r, 1);
        for (; ;) {
            if (k ? n == m || n == Ih(b, m, 1) : 1 >= n - m) {
                for (var s = o > d || q - d >= d - o ? m : n, t = d - (s == m ? o : q); Wg(b.text.charAt(s));)++s;
    ...
    function xc(a) {
        ...
        if (null == wc) {
            wc = Xg("pre");
            for (var b = 0; 49 > b; ++b)wc.appendChild(document.createTextNode("x")), wc.appendChild(Xg("br"));
            wc.appendChild(document.createTextNode("x"))
        }
        $g(a.measure, wc);
        var c = wc.offsetHeight / 50;
        return c > 3 && (a.cachedTextHeight = c), Zg(a.measure), c || 1
    }

    function yc(a) {
        if (null != a.cachedCharWidth)return a.cachedCharWidth;
        var b = Xg("span", "xxxxxxxxxx"), c = Xg("pre", [b]);
        $g(a.measure, c);
    ...
    function Bc(a) {
        a.curOp = {
            ...
            scrollToPos: null,
            id: ++Ac
        }, zc ? zc.ops.push(a.curOp) : a.curOp.ownsGroup = zc = {ops: [a.curOp], delayedCallbacks: []}
    }
    ...
    function Hc(a) {
        var b = a.cm, c = b.display;
        a.updatedDisplay && Z(b), a.barMeasure = M(b), c.maxLineChanged && !b.options.lineWrapping && (a.adjustWidthTo = cc(b, c.maxLine, c.maxLine.text.length).left + 3, a.maxScrollLeft = Math.max(0, c.sizer.offsetLeft + a.adjustWidthTo + Ag - c.scroller.clientWidth)), (a.updatedDisplay || a.selectionChanged) && (a.newSelectionNodes = Ob(b))
    }
    ...
    function Jc(a) {
        ...
        if (null != a.adjustWidthTo && Math.abs(a.barMeasure.scrollWidth - b.display.scroller.scrollWidth) > 1 && N(b), a.updatedDisplay && V(b, a.update), null == c.wheelStartX || null == a.scrollTop && null == a.scrollLeft && !a.scrollToPos || (c.wheelStartX = c.wheelStartY = null), null != a.scrollTop && c.scroller.scrollTop != a.scrollTop) {
        ...
        if (a.scrollToPos) {
            var h = Zd(b, xb(d, a.scrollToPos.from), xb(d, a.scrollToPos.to), a.scrollToPos.margin);
            a.scrollToPos.isCursor && b.state.focused && Yd(b, h)
        }
        var i = a.maybeHiddenMarkers, j = a.maybeUnhiddenMarkers;
        if (i)for (var k = 0; k < i.length; ++k)i[k].lines.length || sg(i[k], "hide");
        if (j)for (var k = 0; k < j.length; ++k)j[k].lines.length && sg(j[k], "unhide");
        c.wrapper.offsetHeight && (d.scrollTop = b.display.scroller.scrollTop), a.updatedDisplay && f && (b.options.lineWrapping && Y(b, a.barMeasure), a.barMeasure.scrollWidth > a.barMeasure.clientWidth && a.barMeasure.scrollWidth < a.barMeasure.clientWidth + 1 && !L(b) && N(b)), a.changeObjs && sg(b, "changes", b, a.changeObjs)
    }
    ...
    function Oc(a, b, c) {
        this.line = b, this.rest = bf(b), this.size = this.rest ? Tf(Kg(this.rest)) - c + 1 : 1, this.node = this.text = null, this.hidden = ef(a, b)
    }

    function Pc(a, b, c) {
        for (var e, d = [], f = b; c > f; f = e) {
            var g = new Oc(a.doc, Pf(a.doc, f), f);
            e = f + g.size, d.push(g)
        }
        return d
    }
    ...
    function Qc(a, b, c, d) {
        ...
        var e = a.display;
        if (d && c < e.viewTo && (null == e.updateLineNumbers || e.updateLineNumbers > b) && (e.updateLineNumbers = b), a.curOp.viewChanged = !0, b >= e.viewTo) v && cf(a.doc, b) < e.viewTo && Sc(a); else if (c <= e.viewFrom) v && df(a.doc, c + d) > e.viewFrom ? Sc(a) : (e.viewFrom += d, e.viewTo += d); else if (b <= e.viewFrom && c >= e.viewTo) Sc(a); else if (b <= e.viewFrom) {
            var f = Uc(a, c, c + d, 1);
            f ? (e.view = e.view.slice(f.index), e.viewFrom = f.lineN, e.viewTo += d) : Sc(a)
        } else if (c >= e.viewTo) {
            var f = Uc(a, b, b, -1);
            f ? (e.view = e.view.slice(0, f.index), e.viewTo = f.lineN) : Sc(a)
        } else {
            var g = Uc(a, b, b, -1), h = Uc(a, c, c + d, 1);
            g && h ? (e.view = e.view.slice(0, g.index).concat(Pc(a, g.lineN, h.lineN)).concat(e.view.slice(h.index)), e.viewTo += d) : Sc(a)
        }
    ...
    function Uc(a, b, c, d) {
        var f, e = Tc(a, b), g = a.display.view;
    ...
    function Vc(a, b, c) {
        ...
        0 == e.length || b >= d.viewTo || c <= d.viewFrom ? (d.view = Pc(a, b, c), d.viewFrom = b) : (d.viewFrom > b ? d.view = Pc(a, b, d.viewFrom).concat(d.view) : d.viewFrom < b && (d.view = d.view.slice(Tc(a, b))), d.viewFrom = b, d.viewTo < c ? d.view = d.view.concat(Pc(a, d.viewTo, c)) : d.viewTo > c && (d.view = d.view.slice(0, Tc(a, c)))), d.viewTo = c
    }
    ...
    function Yc(a) {
        function c() {
            var d = $c(a);
            d || b ? (a.display.pollingFast = !1, Xc(a)) : (b = !0, a.display.poll.set(60, c))
        }
    ...
    function $c(a) {
        ...
        if (!a.state.focused || rh(b) && !c || cd(a) || a.options.disableInput)return !1;
        ...
        if (d && e >= 9 && a.display.inputHasSelection === g || p && /[\uf700-\uf7ff]/.test(g))return _c(a), !1;
        var h = !a.curOp;
        h && Bc(a), a.display.shift = !1, 8203 != g.charCodeAt(0) || f.sel != a.display.selForContextMenu || c || (c = "\u200b");
        for (var i = 0, j = Math.min(c.length, g.length); j > i && c.charCodeAt(i) == g.charCodeAt(i);)++i;
        var k = g.slice(i), l = qh(k), m = null;
        a.state.pasteIncoming && f.sel.ranges.length > 1 && (Zc && Zc.join("\n") == k ? m = 0 == f.sel.ranges.length % Zc.length && Ng(Zc, qh) : l.length == f.sel.ranges.length && (m = Ng(l, function (a) {
                return [a]
            })));
        for (var n = f.sel.ranges.length - 1; n >= 0; n--) {
            var o = f.sel.ranges[n], q = o.from(), r = o.to();
            i < c.length ? q = nb(q.line, q.ch - (c.length - i)) : a.state.overwrite && o.empty() && !a.state.pasteIncoming && (r = nb(r.line, Math.min(Pf(f, r.line).text.length, r.ch + Kg(l).length)));
            ...
            if (Rd(a.doc, t), ug(a, "inputRead", a, t), k && !a.state.pasteIncoming && a.options.electricChars && a.options.smartIndent && o.head.ch < 100 && (!n || f.sel.ranges[n - 1].head.line != o.head.line)) {
                var u = a.getModeAt(o.head);
                if (u.electricChars) {
                    for (var v = 0; v < u.electricChars.length; v++)if (k.indexOf(u.electricChars.charAt(v)) > -1) {
                        de(a, o.head.line, "smart");
                        break
                    }
                } else if (u.electricInput) {
                    var w = Ld(t);
                    u.electricInput.test(Pf(f, w.line).text.slice(0, w.ch)) && de(a, o.head.line, "smart")
                }
            }
        }
        return be(a), a.curOp.updateInput = s, a.curOp.typing = !0, g.length > 1e3 || g.indexOf("\n") > -1 ? b.value = a.display.prevInput = "" : a.display.prevInput = g, h && Dc(a), a.state.pasteIncoming = a.state.cutIncoming = !1, !0
    }
    ...
    function _c(a, b) {
        ...
        if (a.somethingSelected()) {
            a.display.prevInput = "";
            var h = g.sel.primary();
            c = sh && (h.to().line - h.from().line > 100 || (f = a.getSelection()).length > 1e3);
            var i = c ? "-" : f || a.getSelection();
            a.display.input.value = i, a.state.focused && Lg(a.display.input), d && e >= 9 && (a.display.inputHasSelection = i)
        } else b || (a.display.prevInput = a.display.input.value = "", d && e >= 9 && (a.display.inputHasSelection = null));
        a.display.inaccurateSelection = c
    }

    function ad(a) {
        "nocursor" == a.options.readOnly || o && ah() == a.display.input || a.display.input.focus()
    }
    ...
    function dd(a) {
        function c() {
            a.state.focused && setTimeout(Qg(ad, a), 0)
        }
        ...
        function h(c) {
            if (a.somethingSelected()) Zc = a.getSelections(), b.inaccurateSelection && (b.prevInput = "", b.inaccurateSelection = !1, b.input.value = Zc.join("\n"), Lg(b.input)); else {
                ...
                "cut" == c.type ? a.setSelections(e, null, Cg) : (b.prevInput = "", b.input.value = d.join("\n"), Lg(b.input)), Zc = d
            }
            "cut" == c.type && (a.state.cutIncoming = !0)
        }

        var b = a.display;
        qg(b.scroller, "mousedown", Lc(a, hd)), d && 11 > e ? qg(b.scroller, "dblclick", Lc(a, function (b) {
                if (!wg(a, b)) {
                    var c = gd(a, b);
            ...
            })) : qg(b.scroller, "dblclick", function (b) {
                wg(a, b) || kg(b)
            }), qg(b.lineSpace, "selectstart", function (a) {
            fd(b, a) || kg(a)
        }), t || qg(b.scroller, "contextmenu", function (b) {
            Jd(a, b)
        }), qg(b.scroller, "scroll", function () {
            b.scroller.clientHeight && (sd(a, b.scroller.scrollTop), td(a, b.scroller.scrollLeft, !0), sg(a, "scroll", a))
        }), qg(b.scrollbarV, "scroll", function () {
            b.scroller.clientHeight && sd(a, b.scrollbarV.scrollTop)
        }), qg(b.scrollbarH, "scroll", function () {
            b.scroller.clientHeight && td(a, b.scrollbarH.scrollLeft)
        }), qg(b.scroller, "mousewheel", function (b) {
            wd(a, b)
        }), qg(b.scroller, "DOMMouseScroll", function (b) {
            wd(a, b)
        }), qg(b.scrollbarH, "mousedown", c), qg(b.scrollbarV, "mousedown", c), qg(b.wrapper, "scroll", function () {
            b.wrapper.scrollTop = b.wrapper.scrollLeft = 0
        }), qg(b.input, "keyup", function (b) {
            Fd.call(a, b)
        }), qg(b.input, "input", function () {
            d && e >= 9 && a.display.inputHasSelection && (a.display.inputHasSelection = null), Yc(a)
        }), qg(b.input, "keydown", Lc(a, Dd)), qg(b.input, "keypress", Lc(a, Gd)), qg(b.input, "focus", Qg(Hd, a)), qg(b.input, "blur", Qg(Id, a)), a.options.dragDrop && (qg(b.scroller, "dragstart", function (b) {
            rd(a, b)
        }), qg(b.scroller, "dragenter", g), qg(b.scroller, "dragover", g), qg(b.scroller, "drop", Lc(a, qd))), qg(b.scroller, "paste", function (c) {
            fd(b, c) || (a.state.pasteIncoming = !0, ad(a), Yc(a))
        }), qg(b.input, "paste", function () {
        ...
        }), qg(b.input, "cut", h), qg(b.input, "copy", h), k && qg(b.sizer, "mouseup", function () {
            ah() == b.input && b.input.blur(), ad(a)
        })
    }
    ...
    function fd(a, b) {
        for (var c = og(b); c != a.wrapper; c = c.parentNode)if (!c || c.ignoreEvents || c.parentNode == a.sizer && c != a.mover)return !0
    }
    ...
    function gd(a, b, c, d) {
        ...
        var k, j = uc(a, g, h);
        if (d && 1 == j.xRel && (k = Pf(a.doc, j.line).text).length == j.ch) {
            var l = Gg(k, k.length, a.options.tabSize) - k.length;
            j = nb(j.line, Math.max(0, Math.round((g - $b(a.display).left) / yc(a.display)) - l))
        }
        return j
    }
    ...
    function hd(a) {
        if (!wg(this, a)) {
            ...
            if (c.shift = a.shiftKey, fd(c, a))return f || (c.scroller.draggable = !1, setTimeout(function () {
                c.scroller.draggable = !0
            }, 100)), void 0;
            if (!od(b, a)) {
                var d = gd(b, a);
                switch (window.focus(), pg(a)) {
                    case 1:
                        d ? kd(b, a, d) : og(a) == c.scroller && kg(a);
                        break;
                    case 2:
                        f && (b.state.lastMiddleDown = +new Date), d && Cb(b.doc, d), setTimeout(Qg(ad, b), 20), kg(a);
                        break;
                    case 3:
                        t && Jd(b, a)
                }
    ...
    function kd(a, b, c) {
        setTimeout(Qg(bd, a), 0);
        var e, d = +new Date;
        jd && jd.time > d - 400 && 0 == ob(jd.pos, c) ? e = "triple" : id && id.time > d - 400 && 0 == ob(id.pos, c) ? (e = "double", jd = {
                    time: d,
                    pos: c
                }) : (e = "single", id = {time: d, pos: c});
        var f = a.doc.sel, g = p ? b.metaKey : b.ctrlKey;
        a.options.dragDrop && jh && !cd(a) && "single" == e && f.contains(c) > -1 && f.somethingSelected() ? ld(a, b, c, g) : md(a, b, c, e, g)
    }

    function ld(a, b, c, g) {
        var h = a.display, i = Lc(a, function (j) {
            f && (h.scroller.draggable = !1), a.state.draggingText = !1, rg(document, "mouseup", i), rg(h.scroller, "drop", i), Math.abs(b.clientX - j.clientX) + Math.abs(b.clientY - j.clientY) < 10 && (kg(j), g || Cb(a.doc, c), ad(a), d && 9 == e && setTimeout(function () {
                document.body.focus(), ad(a)
            }, 20))
        });
        f && (h.scroller.draggable = !0), a.state.draggingText = i, h.scroller.dragDrop && h.scroller.dragDrop(), qg(document, "mouseup", i), qg(h.scroller, "drop", i)
    }

    function md(a, b, c, d, e) {
        function n(b) {
            if (0 != ob(m, b))if (m = b, "rect" == d) {
                for (var e = [], f = a.options.tabSize, k = Gg(Pf(g, c.line).text, c.ch, f), l = Gg(Pf(g, b.line).text, b.ch, f), n = Math.min(k, l), o = Math.max(k, l), p = Math.min(c.line, b.line), q = Math.min(a.lastLine(), Math.max(c.line, b.line)); q >= p; p++) {
                    var r = Pf(g, p).text, s = Hg(r, n, f);
                    n == o ? e.push(new tb(nb(p, s), nb(p, s))) : r.length > s && e.push(new tb(nb(p, s), nb(p, Hg(r, o, f))))
                }
                ...
                if ("single" != d) {
                    if ("double" == d)var w = ie(a, b); else var w = new tb(nb(b.line, 0), xb(g, nb(b.line + 1, 0)));
                    ob(w.anchor, u) > 0 ? (v = w.head, u = rb(t.from(), w.anchor)) : (v = w.anchor, u = qb(t.to(), w.head))
                }
                var e = j.ranges.slice(0);
                e[i] = new tb(xb(g, u), v), Ib(g, ub(e, i), Dg)
            }
        }

        function q(b) {
            var c = ++p, e = gd(a, b, !0, "rect" == d);
            if (e)if (0 != ob(e, m)) {
                bd(a), n(e);
                var h = O(f, g);
                (e.line >= h.to || e.line < h.from) && setTimeout(Lc(a, function () {
                    p == c && q(b)
                }), 150)
            } else {
                var i = b.clientY < o.top ? -20 : b.clientY > o.bottom ? 20 : 0;
                i && setTimeout(Lc(a, function () {
        ...
        function r(b) {
            p = 1 / 0, kg(b), ad(a), rg(document, "mousemove", s), rg(document, "mouseup", t), g.history.lastSelOrigin = null
        }

        var f = a.display, g = a.doc;
        kg(b);
        var h, i, j = g.sel;
        if (e && !b.shiftKey ? (i = g.sel.contains(c), h = i > -1 ? g.sel.ranges[i] : new tb(c, c)) : h = g.sel.primary(), b.altKey) d = "rect", e || (h = new tb(c, c)), c = gd(a, b, !0, !0), i = -1; else if ("double" == d) {
            var k = ie(a, c);
        ...
        e ? i > -1 ? Eb(g, i, h, Dg) : (i = g.sel.ranges.length, Ib(g, ub(g.sel.ranges.concat([h]), i), {
                    scroll: !1,
                    origin: "*mouse"
                })) : (i = 0, Ib(g, new sb([h], 0), Dg), j = g.sel);
        var m = c, o = f.wrapper.getBoundingClientRect(), p = 0, s = Lc(a, function (a) {
            pg(a) ? q(a) : r(a)
        }), t = Lc(a, r);
        qg(document, "mousemove", s), qg(document, "mouseup", t)
    }
    ...
    function nd(a, b, c, d, e) {
        ...
        if (g > i.bottom || !yg(a, c))return mg(b);
        ...
        for (var j = 0; j < a.options.gutters.length; ++j) {
            ...
            if (k && k.getBoundingClientRect().right >= f) {
                var l = Uf(a.doc, g), m = a.options.gutters[j];
                return e(a, c, a, l, m, b), mg(b)
            }
        }
    }

    function od(a, b) {
        return nd(a, b, "gutterClick", !0, ug)
    }

    function qd(a) {
        var b = this;
        if (!wg(b, a) && !fd(b.display, a)) {
            kg(a), d && (pd = +new Date);
            var c = gd(b, a, !0), e = a.dataTransfer.files;
            if (c && !cd(b))if (e && e.length && window.FileReader && window.File)for (var f = e.length, g = Array(f), h = 0, i = function (a, d) {
                var e = new FileReader;
                e.onload = Lc(b, function () {
                    if (g[d] = e.result, ++h == f) {
                        c = xb(b.doc, c);
                        var a = {from: c, to: c, text: qh(g.join("\n")), origin: "paste"};
                        Rd(b.doc, a), Hb(b.doc, vb(c, Ld(a)))
                    }
                }), e.readAsText(a)
            }, j = 0; f > j; ++j)i(e[j], j); else {
                if (b.state.draggingText && b.doc.sel.contains(c) > -1)return b.state.draggingText(a), setTimeout(Qg(ad, b), 20), void 0;
                try {
                    var g = a.dataTransfer.getData("Text");
                    if (g) {
                        if (b.state.draggingText && !(p ? a.metaKey : a.ctrlKey))var k = b.listSelections();
                        if (Jb(b.doc, vb(c, c)), k)for (var j = 0; j < k.length; ++j)Xd(b.doc, "", k[j].anchor, k[j].head, "drag");
    ...
    function rd(a, b) {
        if (d && (!a.state.draggingText || +new Date - pd < 100))return ng(b), void 0;
        if (!wg(a, b) && !fd(a.display, b) && (b.dataTransfer.setData("Text", a.getSelection()), b.dataTransfer.setDragImage && !j)) {
            var c = Xg("img", null, null, "position: fixed; left: 0; top: 0;");
    ...
    function sd(b, c) {
        Math.abs(b.doc.scrollTop - c) < 2 || (b.doc.scrollTop = c, a || W(b, {top: c}), b.display.scroller.scrollTop != c && (b.display.scroller.scrollTop = c), b.display.scrollbarV.scrollTop != c && (b.display.scrollbarV.scrollTop = c), a && W(b), Ub(b, 100))
    }
    ...
    function wd(b, c) {
        ...
        if (d && h.scrollWidth > h.clientWidth || e && h.scrollHeight > h.clientHeight) {
            ...
            if (d && !a && !i && null != vd)return e && sd(b, Math.max(0, Math.min(h.scrollTop + e * vd, h.scrollHeight - h.clientHeight))), td(b, Math.max(0, Math.min(h.scrollLeft + d * vd, h.scrollWidth - h.clientWidth))), kg(c), g.wheelStartX = null, void 0;
            if (e && null != vd) {
                var m = e * vd, n = b.doc.scrollTop, o = n + g.wrapper.clientHeight;
                0 > m ? n = Math.max(0, n + m - 50) : o = Math.min(b.doc.height, o + m + 50), W(b, {top: n, bottom: o})
            }
            20 > ud && (null == g.wheelStartX ? (g.wheelStartX = h.scrollLeft, g.wheelStartY = h.scrollTop, g.wheelDX = d, g.wheelDY = e, setTimeout(function () {
                    if (null != g.wheelStartX) {
                        ...
                        g.wheelStartX = g.wheelStartY = null, c && (vd = (vd * ud + c) / (ud + 1), ++ud)
                    }
    ...
    function xd(a, b, c) {
        if ("string" == typeof b && (b = ue[b], !b))return !1;
        a.display.pollingFast && $c(a) && (a.display.pollingFast = !1);
        var d = a.display.shift, e = !1;
        try {
            cd(a) && (a.state.suppressEdits = !0), c && (a.display.shift = !1), e = b(a) != Bg
        } finally {
    ...
    function Ad(a, b) {
        var c = we(a.options.keyMap), d = c.auto;
        clearTimeout(zd), d && !ye(b) && (zd = setTimeout(function () {
            we(a.options.keyMap) == c && (a.options.keyMap = d.call ? d.call(null, a) : d, D(a))
        }, 50));
        var e = ze(b, !0), f = !1;
        if (!e)return !1;
        var g = yd(a);
        return f = b.shiftKey ? xe("Shift-" + e, g, function (b) {
                return xd(a, b, !0)
            }) || xe(e, g, function (b) {
                return ("string" == typeof b ? /^go[A-Z]/.test(b) : b.motion) ? xd(a, b) : void 0
            }) : xe(e, g, function (b) {
                return xd(a, b)
            }), f && (kg(b), Tb(a), ug(a, "keyHandled", a, e, b)), f
    }

    function Bd(a, b, c) {
        var d = xe("'" + c + "'", yd(a), function (b) {
            return xd(a, b, !0)
        });
        return d && (kg(b), Tb(a), ug(a, "keyHandled", a, "'" + c + "'", b)), d
    }
    ...
    function Dd(a) {
        ...
        if (bd(b), !wg(b, a)) {
            ...
            var f = Ad(b, a);
            i && (Cd = f ? c : null, !f && 88 == c && !sh && (p ? a.metaKey : a.ctrlKey) && b.replaceSelection("", null, "cut")), 18 != c || /\bCodeMirror-crosshair\b/.test(b.display.lineDiv.className) || Ed(b)
        }
    }

    function Ed(a) {
        function c(a) {
            18 != a.keyCode && a.altKey || (ch(b, "CodeMirror-crosshair"), rg(document, "keyup", c), rg(document, "mouseover", c))
        }

        var b = a.display.lineDiv;
        dh(b, "CodeMirror-crosshair"), qg(document, "keyup", c), qg(document, "mouseover", c)
    }

    function Fd(a) {
        16 == a.keyCode && (this.doc.sel.shift = !1), wg(this, a)
    }

    function Gd(a) {
        var b = this;
        if (!(wg(b, a) || a.ctrlKey && !a.altKey || p && a.metaKey)) {
            var c = a.keyCode, f = a.charCode;
            if (i && c == Cd)return Cd = null, kg(a), void 0;
            if (!(i && (!a.which || a.which < 10) || k) || !Ad(b, a)) {
                var g = String.fromCharCode(null == f ? c : f);
                Bd(b, a, g) || (d && e >= 9 && (b.display.inputHasSelection = null), Yc(b))
            }
        }
    }

    function Hd(a) {
        "nocursor" != a.options.readOnly && (a.state.focused || (sg(a, "focus", a), a.state.focused = !0, dh(a.display.wrapper, "CodeMirror-focused"), a.curOp || a.display.selForContextMenu == a.doc.sel || (_c(a), f && setTimeout(Qg(_c, a, !0), 0))), Xc(a), Tb(a))
    }

    function Id(a) {
        a.state.focused && (sg(a, "blur", a), a.state.focused = !1, ch(a.display.wrapper, "CodeMirror-focused")), clearInterval(a.display.blinker), setTimeout(function () {
    ...
    function Jd(a, b) {
        ...
        function n() {
            if (c.inputDiv.style.position = "relative", c.input.style.cssText = k, d && 9 > e && (c.scrollbarV.scrollTop = c.scroller.scrollTop = h), Xc(a), null != c.input.selectionStart) {
                (!d || d && 9 > e) && m();
                var b = 0, f = function () {
                    c.selForContextMenu == a.doc.sel && 0 == c.input.selectionStart ? Lc(a, ue.selectAll)(a) : b++ < 10 ? c.detectingSelectAll = setTimeout(f, 500) : _c(a)
                };
                c.detectingSelectAll = setTimeout(f, 200)
            }
        }

        if (!wg(a, b, "contextmenu")) {
            var c = a.display;
            if (!fd(c, b) && !Kd(a, b)) {
                var g = gd(a, b), h = c.scroller.scrollTop;
                if (g && !i) {
                    var j = a.options.resetSelectionOnContextMenu;
                    j && -1 == a.doc.sel.contains(g) && Lc(a, Ib)(a.doc, vb(g), Cg);
                    ...
                    if (ad(a), f && window.scrollTo(null, l), _c(a), a.somethingSelected() || (c.input.value = c.prevInput = " "), c.selForContextMenu = a.doc.sel, clearTimeout(c.detectingSelectAll), d && e >= 9 && m(), t) {
                        ng(b);
                        var o = function () {
                            rg(window, "mouseup", o), setTimeout(n, 20)
                        };
                        qg(window, "mouseup", o)
    ...
    function Kd(a, b) {
        return yg(a, "gutterContextMenu") ? nd(a, b, "gutterContextMenu", !1, sg) : !1
    }
    ...
    function Pd(a, b, c) {
        for (var d = [], e = nb(a.first, 0), f = e, g = 0; g < b.length; g++) {
            var h = b[g], i = Od(h.from, e, f), j = Od(Ld(h), e, f);
    ...
    function Qd(a, b, c) {
        ...
        }), sg(a, "beforeChange", a, d), a.cm && sg(a.cm, "beforeChange", a.cm, d), d.canceled ? null : {
                from: d.from,
                to: d.to,
                text: d.text,
                origin: d.origin
    ...
    function Rd(a, b, c) {
        ...
        if (!(yg(a, "beforeChange") || a.cm && yg(a.cm, "beforeChange")) || (b = Qd(a, b, !0))) {
            var d = u && !c && Se(a, b.from, b.to);
            if (d)for (var e = d.length - 1; e >= 0; --e)Sd(a, {
                from: d[e].from,
                to: d[e].to,
                text: e ? [""] : b.text
            }); else Sd(a, b)
    ...
    function Sd(a, b) {
        if (1 != b.text.length || "" != b.text[0] || 0 != ob(b.from, b.to)) {
            var c = Nd(a, b);
            _f(a, b, c, a.cm ? a.cm.curOp.id : 0 / 0), Vd(a, b, c, Pe(a, b));
            var d = [];
            Nf(a, function (a, c) {
                c || -1 != Mg(d, a.history) || (jg(a.history, b), d.push(a.history)), Vd(a, b, null, Pe(a, b))
            })
        }
    }
        ...
        if (!a.cm || !a.cm.state.suppressEdits) {
            ...
            if (i != g.length) {
                for (d.lastOrigin = d.lastSelOrigin = null; e = g.pop(), e.ranges;) {
                    if (cg(e, h), c && !e.equals(a.sel))return Ib(a, e, {clearRedo: !1}), void 0;
                    f = e
                }
                var j = [];
                cg(f, h), h.push({
                ...
                for (var k = yg(a, "beforeChange") || a.cm && yg(a.cm, "beforeChange"), i = e.changes.length - 1; i >= 0; --i) {
                    var l = e.changes[i];
                    if (l.origin = b, k && !Qd(a, l, !1))return g.length = 0, void 0;
                    j.push(Yf(a, l));
                    var m = i ? Nd(a, l) : Kg(g);
                    Vd(a, l, m, Re(a, l)), !i && a.cm && a.cm.scrollIntoView({from: l.from, to: Ld(l)});
                    var n = [];
                    Nf(a, function (a, b) {
                        b || -1 != Mg(n, a.history) || (jg(a.history, l), n.push(a.history)), Vd(a, l, null, Re(a, l))
                    })
                }
            }
        }
    ...
    function Ud(a, b) {
        if (0 != b && (a.first += b, a.sel = new sb(Ng(a.sel.ranges, function (a) {
                return new tb(nb(a.anchor.line + b, a.anchor.ch), nb(a.head.line + b, a.head.ch))
            }), a.sel.primIndex), a.cm)) {
            Qc(a.cm, a.first, a.first - b, b);
            for (var c = a.cm.display, d = c.viewFrom; d < c.viewTo; d++)Rc(a.cm, d, "gutter")
        }
    }

    function Vd(a, b, c, d) {
        if (a.cm && !a.cm.curOp)return Lc(a.cm, Vd)(a, b, c, d);
        if (b.to.line < a.first)return Ud(a, b.text.length - 1 - (b.to.line - b.from.line)), void 0;
        if (!(b.from.line > a.lastLine())) {
            ...
            b.to.line > f && (b = {
                from: b.from,
                to: nb(f, Pf(a, f).text.length),
                text: [b.text[0]],
                origin: b.origin
            }), b.removed = Qf(a, b.from, b.to), c || (c = Nd(a, b)), a.cm ? Wd(a.cm, b, d) : Gf(a, b, d), Jb(a, c, Cg)
        }
    }

    function Wd(a, b, c) {
        var d = a.doc, e = a.display, f = b.from, g = b.to, h = !1, i = f.line;
        a.options.lineWrapping || (i = Tf(af(Pf(d, f.line))), d.iter(i, g.line + 1, function (a) {
            return a == e.maxLine ? (h = !0, !0) : void 0
        })), d.sel.contains(b.from, b.to) > -1 && xg(a), Gf(d, b, c, B(a)), a.options.lineWrapping || (d.iter(i, f.line + b.text.length, function (a) {
            var b = I(a);
            b > e.maxLineLength && (e.maxLine = a, e.maxLineLength = b, e.maxLineChanged = !0, h = !1)
        }), h && (a.curOp.updateMaxLine = !0)), d.frontier = Math.min(d.frontier, f.line), Ub(a, 400);
        var j = b.text.length - (g.line - f.line) - 1;
        f.line != g.line || 1 != b.text.length || Ff(a.doc, b) ? Qc(a, f.line, g.line + 1, j) : Rc(a, f.line, "text");
        var k = yg(a, "changes"), l = yg(a, "change");
        if (l || k) {
            var m = {from: f, to: g, text: b.text, removed: b.removed, origin: b.origin};
            l && ug(a, "change", a, m), k && (a.curOp.changeObjs || (a.curOp.changeObjs = [])).push(m)
        }
    ...
    function Xd(a, b, c, d, e) {
        ...
        "string" == typeof b && (b = qh(b)), Rd(a, {from: c, to: d, text: b, origin: e})
    }
    ...
    function Yd(a, b) {
        ...
        if (b.top + d.top < 0 ? e = !0 : b.bottom + d.top > (window.innerHeight || document.documentElement.clientHeight) && (e = !1), null != e && !m) {
            var f = Xg("div", "\u200b", null, "position: absolute; top: " + (b.top - c.viewOffset - Yb(a.display)) + "px; height: " + (b.bottom - b.top + Ag) + "px; left: " + b.left + "px; width: 2px;");
    ...
    function Zd(a, b, c, d) {
        for (null == d && (d = 0); ;) {
            var e = !1, f = rc(a, b), g = c && c != b ? rc(a, c) : f, h = _d(a, Math.min(f.left, g.left), Math.min(f.top, g.top) - d, Math.max(f.left, g.left), Math.max(f.bottom, g.bottom) + d), i = a.doc.scrollTop, j = a.doc.scrollLeft;
            if (null != h.scrollTop && (sd(a, h.scrollTop), Math.abs(a.doc.scrollTop - i) > 1 && (e = !0)), null != h.scrollLeft && (td(a, h.scrollLeft), Math.abs(a.doc.scrollLeft - j) > 1 && (e = !0)), !e)return f
        }
    }

    function $d(a, b, c, d, e) {
        var f = _d(a, b, c, d, e);
        null != f.scrollTop && sd(a, f.scrollTop), null != f.scrollLeft && td(a, f.scrollLeft)
    }

    function _d(a, b, c, d, e) {
        var f = a.display, g = xc(a.display);
        0 > c && (c = 0);
        var h = a.curOp && null != a.curOp.scrollTop ? a.curOp.scrollTop : f.scroller.scrollTop, i = f.scroller.clientHeight - Ag, j = {};
        e - c > i && (e = c + i);
        var k = a.doc.height + Zb(f), l = g > c, m = e > k - g;
        if (h > c) j.scrollTop = l ? 0 : c; else if (e > h + i) {
            var n = Math.min(c, (m ? k : e) - i);
            n != h && (j.scrollTop = n)
        }
        var o = a.curOp && null != a.curOp.scrollLeft ? a.curOp.scrollLeft : f.scroller.scrollLeft, p = f.scroller.clientWidth - Ag - f.gutters.offsetWidth, q = d - b > p;
        return q && (d = c + i), 10 > b ? j.scrollLeft = 0 : o > b ? j.scrollLeft = Math.max(0, b - (q ? 0 : 10)) : d > p + o - 3 && (j.scrollLeft = d + (q ? 0 : 10) - p), j
    }

    function ae(a, b, c) {
        (null != b || null != c) && ce(a), null != b && (a.curOp.scrollLeft = (null == a.curOp.scrollLeft ? a.doc.scrollLeft : a.curOp.scrollLeft) + b), null != c && (a.curOp.scrollTop = (null == a.curOp.scrollTop ? a.doc.scrollTop : a.curOp.scrollTop) + c)
    }
    ...
    function ce(a) {
        ...
        if (b) {
            ...
            var c = sc(a, b.from), d = sc(a, b.to), e = _d(a, Math.min(c.left, d.left), Math.min(c.top, d.top) - b.margin, Math.max(c.right, d.right), Math.max(c.bottom, d.bottom) + b.margin);
    ...
    function de(a, b, c, d) {
        var f, e = a.doc;
        null == c && (c = "add"), "smart" == c && (e.mode.indent ? f = Xb(a, b) : c = "prev");
        var g = a.options.tabSize, h = Pf(e, b), i = Gg(h.text, null, g);
        h.stateAfter && (h.stateAfter = null);
        var k, j = h.text.match(/^\s*/)[0];
        if (d || /\S/.test(h.text)) {
            if ("smart" == c && (k = e.mode.indent(f, h.text.slice(j.length), h.text), k == Bg || k > 150)) {
                if (!d)return;
                c = "prev"
            }
        } else k = 0, c = "not";
        "prev" == c ? k = b > e.first ? Gg(Pf(e, b - 1).text, null, g) : 0 : "add" == c ? k = i + a.options.indentUnit : "subtract" == c ? k = i - a.options.indentUnit : "number" == typeof c && (k = i + c), k = Math.max(0, k);
        var l = "", m = 0;
        if (a.options.indentWithTabs)for (var n = Math.floor(k / g); n; --n)m += g, l += "	";
        if (k > m && (l += Jg(k - m)), l != j) Xd(e, l, nb(b, 0), nb(b, j.length), "+input"); else for (var n = 0; n < e.sel.ranges.length; n++) {
    ...
    function ee(a, b, c, d) {
        var e = b, f = b;
        return "number" == typeof b ? f = Pf(a, wb(a, b)) : e = Tf(b), null == e ? null : (d(f, e) && a.cm && Rc(a.cm, e, c), f)
    }

    function fe(a, b) {
        for (var c = a.doc.sel.ranges, d = [], e = 0; e < c.length; e++) {
            for (var f = b(c[e]); d.length && ob(f.from, Kg(d).to) <= 0;) {
                var g = d.pop();
        ...
        Kc(a, function () {
            for (var b = d.length - 1; b >= 0; b--)Xd(a.doc, "", d[b].from, d[b].to, "+delete");
            be(a)
        })
    }
    ...
    function ge(a, b, c, d, e) {
        function k() {
            var b = f + c;
            return b < a.first || b >= a.first + a.size ? j = !1 : (f = b, i = Pf(a, b))
        }

        function l(a) {
            var b = (e ? Ih : Jh)(i, g, c, !0);
            if (null == b) {
                if (a || !k())return j = !1;
                g = e ? (0 > c ? Ah : zh)(i) : 0 > c ? i.text.length : 0
            } else g = b;
            return !0
        }

        var f = b.line, g = b.ch, h = c, i = Pf(a, f), j = !0;
    ...
    function he(a, b, c, d) {
        ...
        if ("page" == d) {
            ...
            g = b.top + c * (h - (0 > c ? 1.5 : .5) * xc(a.display))
    ...
    function ie(a, b) {
        var c = a.doc, d = Pf(c, b.line).text, e = b.ch, f = b.ch;
        if (d) {
            var g = a.getHelper(b, "wordChars");
            (b.xRel < 0 || f == d.length) && e ? --e : ++f;
            for (var h = d.charAt(e), i = Tg(h, g) ? function (a) {
                    return Tg(a, g)
                } : /\s/.test(h) ? function (a) {
                        return /\s/.test(a)
                    } : function (a) {
                        return !/\s/.test(a) && !Tg(a)
    ...
    function le(a, b, c, d) {
        w.defaults[a] = b, c && (ke[a] = d ? function (a, b, d) {
                d != me && c(a, b, d)
            } : c)
    }

    function we(a) {
        return "string" == typeof a ? ve[a] : a
    }

    function De(a, b, c, d, e) {
        if (d && d.shared)return Fe(a, b, c, d, e);
        if (a.cm && !a.cm.curOp)return Lc(a.cm, De)(a, b, c, d, e);
        var f = new Be(a, e), g = ob(b, c);
        if (d && Pg(d, f, !1), g > 0 || 0 == g && f.clearWhenEmpty !== !1)return f;
        if (f.replacedWith && (f.collapsed = !0, f.widgetNode = Xg("span", [f.replacedWith], "CodeMirror-widget"), d.handleMouseEvents || (f.widgetNode.ignoreEvents = !0), d.insertLeft && (f.widgetNode.insertLeft = !0)), f.collapsed) {
            if (_e(a, b.line, b, c, f) || b.line != c.line && _e(a, c.line, b, c, f))throw new Error("Inserting collapsed marker partially overlapping an existing one");
            v = !0
        }
        f.addToHistory && _f(a, {from: b, to: c, origin: "markText"}, a.sel, 0 / 0);
        var j, h = b.line, i = a.cm;
        if (a.iter(h, c.line + 1, function (a) {
                i && f.collapsed && !i.options.lineWrapping && af(a) == i.display.maxLine && (j = !0), f.collapsed && h != b.line && Sf(a, 0), Me(a, new Je(f, h == b.line ? b.ch : null, h == c.line ? c.ch : null)), ++h
            }), f.collapsed && a.iter(b.line, c.line + 1, function (b) {
                ef(a, b) && Sf(b, 0)
            }), f.clearOnEnter && qg(f, "beforeCursorEnter", function () {
                f.clear()
            }), f.readOnly && (u = !0, (a.history.done.length || a.history.undone.length) && a.clearHistory()), f.collapsed && (f.id = ++Ce, f.atomic = !0), i) {
            if (j && (i.curOp.updateMaxLine = !0), f.collapsed) Qc(i, b.line, c.line + 1); else if (f.className || f.title || f.startStyle || f.endStyle)for (var k = b.line; k <= c.line; k++)Rc(i, k, "text");
            f.atomic && Lb(i.doc), ug(i, "markerAdded", i, f)
        }
        return f
    }
    ...
    function Fe(a, b, c, d, e) {
        d = Pg(d), d.shared = !1;
        var f = [De(a, b, c, d, e)], g = f[0], h = d.widgetNode;
        return Nf(a, function (a) {
            h && (d.widgetNode = h.cloneNode(!0)), f.push(De(a, xb(a, b), xb(a, c), d, e));
    ...
    function He(a, b) {
        for (var c = 0; c < b.length; c++) {
            ...
            if (ob(f, g)) {
                var h = De(a, f, g, d.primary, d.primary.type);
    ...
    function Ie(a) {
        for (var b = 0; b < a.length; b++) {
            ...
            Nf(c.primary.doc, function (a) {
                d.push(a)
            });
            for (var e = 0; e < c.markers.length; e++) {
                var f = c.markers[e];
                -1 == Mg(d, f.doc) && (f.parent = null, c.markers.splice(e--, 1))
            }
        }
    }
    ...
    function Ne(a, b, c) {
        if (a)for (var e, d = 0; d < a.length; ++d) {
            ...
            if (h || f.from == b && "bookmark" == g.type && (!c || !f.marker.insertLeft)) {
                ...
                (e || (e = [])).push(new Je(g, f.from, i ? null : f.to))
            }
        }
        return e
    }
    ...
    function Oe(a, b, c) {
        if (a)for (var e, d = 0; d < a.length; ++d) {
            ...
            if (h || f.from == b && "bookmark" == g.type && (!c || f.marker.insertLeft)) {
                ...
                (e || (e = [])).push(new Je(g, i ? null : f.from - b, null == f.to ? null : f.to - b))
            }
        }
        return e
    }
    ...
    function Pe(a, b) {
        var c = zb(a, b.from.line) && Pf(a, b.from.line).markedSpans, d = zb(a, b.to.line) && Pf(a, b.to.line).markedSpans;
        if (!c && !d)return null;
        var e = b.from.ch, f = b.to.ch, g = 0 == ob(b.from, b.to), h = Ne(c, e, g), i = Oe(d, f, g), j = 1 == b.text.length, k = Kg(b.text).length + (j ? e : 0);
        ...
        h && (h = Qe(h)), i && i != h && (i = Qe(i));
        var o = [h];
        if (!j) {
            var q, p = b.text.length - 2;
            if (p > 0 && h)for (var l = 0; l < h.length; ++l)null == h[l].to && (q || (q = [])).push(new Je(h[l].marker, null, null));
    ...
    function Se(a, b, c) {
        ...
        if (a.iter(b.line, c.line + 1, function (a) {
                if (a.markedSpans)for (var b = 0; b < a.markedSpans.length; ++b) {
                    ...
                    !c.readOnly || d && -1 != Mg(d, c) || (d || (d = [])).push(c)
                }
            }), !d)return null;
        for (var e = [{
            from: b,
    ...
    function Xe(a, b) {
        ...
        if (0 != c)return c;
        var d = a.find(), e = b.find(), f = ob(d.from, e.from) || Ve(a) - Ve(b);
        if (f)return -f;
        var g = ob(d.to, e.to) || We(a) - We(b);
        return g ? g : b.id - a.id
    }

    function Ye(a, b) {
        var d, c = v && a.markedSpans;
        if (c)for (var e, f = 0; f < c.length; ++f)e = c[f], e.marker.collapsed && null == (b ? e.from : e.to) && (!d || Xe(d, e.marker) < 0) && (d = e.marker);
        return d
    }
    ...
    function _e(a, b, c, d, e) {
        var f = Pf(a, b), g = v && f.markedSpans;
        if (g)for (var h = 0; h < g.length; ++h) {
            var i = g[h];
            if (i.marker.collapsed) {
                var j = i.marker.find(0), k = ob(j.from, c) || Ve(i.marker) - Ve(e), l = ob(j.to, d) || We(i.marker) - We(e);
    ...
    function af(a) {
        for (var b; b = Ze(a);)a = b.find(-1, !0).line;
        return a
    }

    function bf(a) {
        for (var b, c; b = $e(a);)a = b.find(1, !0).line, (c || (c = [])).push(a);
        return c
    }
    ...
    function ef(a, b) {
        ...
        if (c)for (var d, e = 0; e < c.length; ++e)if (d = c[e], d.marker.collapsed) {
            ...
            if (!d.marker.widgetNode && 0 == d.from && d.marker.inclusiveLeft && ff(a, b, d))return !0
        }
    }
    ...
    function ff(a, b, c) {
        if (null == c.to) {
            ...
            return ff(a, d.line, Ke(d.line.markedSpans, c.marker))
        }
        if (c.marker.inclusiveRight && c.to == b.text.length)return !0;
        for (var e, f = 0; f < b.markedSpans.length; ++f)if (e = b.markedSpans[f], e.marker.collapsed && !e.marker.widgetNode && e.from == c.to && (null == e.to || e.to != c.from) && (e.marker.inclusiveLeft || c.marker.inclusiveRight) && ff(a, b, e))return !0
    }

    function hf(a, b, c) {
        Vf(b) < (a.curOp && a.curOp.scrollTop || a.doc.scrollTop) && ae(a, null, c)
    }

    function jf(a) {
        if (null != a.height)return a.height;
        if (!_g(document.body, a.node)) {
            var b = "position: relative;";
            a.coverGutter && (b += "margin-left: -" + a.cm.getGutterElement().offsetWidth + "px;"), $g(a.cm.display.measure, Xg("div", [a.node], null, b))
        }
    ...
    function kf(a, b, c, d) {
        var e = new gf(a, c, d);
        return e.noHScroll && (a.display.alignWidgets = !0), ee(a.doc, b, "widget", function (b) {
            var c = b.widgets || (b.widgets = []);
            if (null == e.insertAt ? c.push(e) : c.splice(Math.min(c.length - 1, Math.max(0, e.insertAt)), 0, e), e.line = b, !ef(a.doc, b)) {
                var d = Vf(b) < a.doc.scrollTop;
                Sf(b, b.height + jf(e)), d && ae(a, null, e.height), a.curOp.forceUpdate = !0
            }
            return !0
        }), e
    }
    ...
    function mf(a, b, c, d) {
        a.text = b, a.stateAfter && (a.stateAfter = null), a.styles && (a.styles = null), null != a.order && (a.order = null), Te(a), Ue(a, c);
        var e = d ? d(a) : 1;
        e != a.height && Sf(a, e)
    }
    ...
    function rf(a, b, c, d, e, f, g) {
        ...
        var l, i = 0, j = null, k = new Ae(b, a.options.tabSize);
        for ("" == b && of(pf(c, d), f); !k.eol();) {
            if (k.pos > a.options.maxHighlightLength ? (h = !1, g && uf(a, b, d, k.pos), k.pos = b.length, l = null) : l = of(qf(c, k, d), f), a.options.addModeClass) {
    ...
    function tf(a, b) {
        if (!b.styles || b.styles[0] != a.state.modeGen) {
            var c = sf(a, b, b.stateAfter = Xb(a, Tf(b)));
    ...
    function uf(a, b, c, d) {
        var e = a.doc.mode, f = new Ae(b, a.options.tabSize);
        for (f.start = f.pos = d || 0, "" == b && pf(e, c); !f.eol() && f.pos <= a.options.maxHighlightLength;)qf(e, f, c), f.start = f.pos
    }

    function xf(a, b) {
        if (!a || /^\s*$/.test(a))return null;
        var c = b.addModeClass ? wf : vf;
        return c[a] || (c[a] = a.replace(/\S+/g, "cm-$&"))
    }

    function yf(a, b) {
        var c = Xg("span", null, null, f ? "padding-right: .1px" : null), e = {
            pre: Xg("pre", [c]),
            content: c,
            col: 0,
            pos: 0,
        ...
        for (var g = 0; g <= (b.rest ? b.rest.length : 0); g++) {
            ...
            e.pos = 0, e.addToken = Af, (d || f) && a.getOption("lineWrapping") && (e.addToken = Bf(e.addToken)), ph(a.display.measure) && (i = Wf(h)) && (e.addToken = Cf(e.addToken, i)), e.map = [], Ef(h, e, tf(a, h)), h.styleClasses && (h.styleClasses.bgClass && (e.bgClass = eh(h.styleClasses.bgClass, e.bgClass || "")), h.styleClasses.textClass && (e.textClass = eh(h.styleClasses.textClass, e.textClass || ""))), 0 == e.map.length && e.map.push(0, 0, e.content.appendChild(nh(a.display.measure))), 0 == g ? (b.measure.map = e.map, b.measure.cache = {}) : ((b.measure.maps || (b.measure.maps = [])).push(e.map), (b.measure.caches || (b.measure.caches = [])).push({}))
        }
        return sg(a, "renderLine", a, b.line, e.pre), e.pre.className && (e.textClass = eh(e.pre.className, e.textClass || "")), e
    }

    function zf(a) {
        var b = Xg("span", "\u2022", "cm-invalidchar");
        return b.title = "\\u" + a.charCodeAt(0).toString(16), b
    }

    function Af(a, b, c, f, g, h) {
        if (b) {
            ...
            if (i.test(b))for (var k = document.createDocumentFragment(), l = 0; ;) {
                ...
                if (n) {
                    ...
                    d && 9 > e ? k.appendChild(Xg("span", [o])) : k.appendChild(o), a.map.push(a.pos, a.pos + n, o), a.col += n, a.pos += n
                }
                if (!m)break;
                if (l += n + 1, "	" == m[0]) {
                    var p = a.cm.options.tabSize, q = p - a.col % p, o = k.appendChild(Xg("span", Jg(q), "cm-tab"));
                    a.col += q
                } else {
                    var o = a.cm.options.specialCharPlaceholder(m[0]);
                    d && 9 > e ? k.appendChild(Xg("span", [o])) : k.appendChild(o), a.col += 1
                }
        ...
        if (d)for (var k, m, n, o, p, q, h = e.length, i = 0, g = 1, j = "", l = 0; ;) {
            if (l == i) {
                ...
                for (var r = [], s = 0; s < d.length; ++s) {
                    ...
                    t.from <= i && (null == t.to || t.to > i) ? (null != t.to && l > t.to && (l = t.to, n = ""), u.className && (m += " " + u.className), u.startStyle && t.from == i && (o += " " + u.startStyle), u.endStyle && t.to == l && (n += " " + u.endStyle), u.title && !p && (p = u.title), u.collapsed && (!q || Xe(q.marker, u) < 0) && (q = t)) : t.from > i && l > t.from && (l = t.from), "bookmark" == u.type && t.from == i && u.widgetNode && r.push(u)
                }
                if (q && (q.from || 0) == i && (Df(b, (null == q.to ? h + 1 : q.to) - i, q.marker, null == q.from), null == q.to))return;
                if (!q && r.length)for (var s = 0; s < r.length; ++s)Df(b, 0, r[s])
            }
            if (i >= h)break;
            for (var v = Math.min(h, l); ;) {
                ...
                j = e.slice(f, f = c[g++]), k = xf(c[g++], b.cm.options)
            }
        } else for (var g = 1; g < c.length; g += 2)b.addToken(b, e.slice(f, f = c[g]), xf(c[g + 1], b.cm.options))
    }

    function Ff(a, b) {
        return 0 == b.from.ch && 0 == b.to.ch && "" == Kg(b.text) && (!a.cm || a.cm.options.wholeLineUpdateBefore)
    }
    ...
    function Gf(a, b, c, d) {
        ...
        function f(a, c, e) {
            mf(a, c, e, d), ug(a, "change", a, b)
        }

        var g = b.from, h = b.to, i = b.text, j = Pf(a, g.line), k = Pf(a, h.line), l = Kg(i), m = e(i.length - 1), n = h.line - g.line;
        if (Ff(a, b)) {
            for (var o = 0, p = []; o < i.length - 1; ++o)p.push(new lf(i[o], e(o), d));
            ...
            for (var p = [], o = 1; o < i.length - 1; ++o)p.push(new lf(i[o], e(o), d));
            p.push(new lf(l + j.text.slice(h.ch), m, d)), f(j, j.text.slice(0, g.ch) + i[0], e(0)), a.insert(g.line + 1, p)
            ...
            for (var o = 1, p = []; o < i.length - 1; ++o)p.push(new lf(i[o], e(o), d));
    ...
    function Of(a, b) {
        ...
        a.doc = b, b.cm = a, C(a), y(a), a.options.lineWrapping || J(a), a.options.mode = b.modeOption, Qc(a)
    }
    ...
    function Tf(a) {
        ...
        for (var b = a.parent, c = Mg(b.lines, a), d = b.parent; d; b = d, d = d.parent)for (var e = 0; d.children[e] != b; ++e)c += d.children[e].chunkSize();
        return c + b.first
    }
    ...
    function Wf(a) {
        var b = a.order;
        return null == b && (b = a.order = Kh(a.text)), b
    }
    ...
    function Yf(a, b) {
        var c = {from: pb(b.from), to: Ld(b), text: Qf(a, b.from, b.to)};
        return dg(a, c, b.from.line, b.to.line + 1), Nf(a, function (a) {
            dg(a, c, b.from.line, b.to.line + 1)
        }, !0), c
    }
    ...
    function $f(a, b) {
        return b ? (Zf(a.done), Kg(a.done)) : a.done.length && !Kg(a.done).ranges ? Kg(a.done) : a.done.length > 1 && !a.done[a.done.length - 2].ranges ? (a.done.pop(), Kg(a.done)) : void 0
    }
    ...
    function _f(a, b, c, d) {
        ...
        e.undone.length = 0;
        var g, f = +new Date;
        if ((e.lastOp == d || e.lastOrigin == b.origin && b.origin && ("+" == b.origin.charAt(0) && a.cm && e.lastModTime > f - a.cm.options.historyEventDelay || "*" == b.origin.charAt(0))) && (g = $f(e, e.lastOp == d))) {
            var h = Kg(g.changes);
            0 == ob(b.from, b.to) && 0 == ob(b.from, h.to) ? h.to = Ld(b) : g.changes.push(Yf(a, b))
        } else {
            var i = Kg(e.done);
            for (i && i.ranges || cg(a.sel, e.done), g = {
                changes: [Yf(a, b)],
                generation: e.generation
            }, e.done.push(g); e.done.length > e.undoDepth;)e.done.shift(), e.done[0].ranges || e.done.shift()
        }
        e.done.push(c), e.generation = ++e.maxGeneration, e.lastModTime = e.lastSelTime = f, e.lastOp = e.lastSelOp = d, e.lastOrigin = e.lastSelOrigin = b.origin, h || sg(a, "historyAdded")
    }
    ...
    function bg(a, b, c, d) {
        ...
        c == e.lastSelOp || f && e.lastSelOrigin == f && (e.lastModTime == e.lastSelTime && e.lastOrigin == f || ag(a, f, Kg(e.done), b)) ? e.done[e.done.length - 1] = b : cg(b, e.done), e.lastSelTime = +new Date, e.lastSelOrigin = f, e.lastSelOp = c, d && d.clearRedo !== !1 && Zf(e.undone)
    }
    ...
    function fg(a, b) {
        var c = b["spans_" + a.id];
        if (!c)return null;
        for (var d = 0, e = []; d < b.text.length; ++d)e.push(eg(c[d]));
        return e
    }
            ...
            if (f.ranges) e.push(c ? sb.prototype.deepCopy.call(f) : f); else {
                ...
                for (var i = 0; i < g.length; ++i) {
                    ...
                    if (h.push({
                            ...
                            to: j.to,
                            text: j.text
                        }), b)for (var l in j)(k = l.match(/^spans_(\d+)$/)) && Mg(b, Number(k[1])) > -1 && (Kg(h)[l] = j[l], delete j[l])
                }
            }
        }
        return e
    ...
    function ig(a, b, c, d) {
        for (var e = 0; e < a.length; ++e) {
            ...
            if (f.ranges) {
                ...
                for (var h = 0; h < f.ranges.length; h++)hg(f.ranges[h].anchor, b, c, d), hg(f.ranges[h].head, b, c, d)
            } else {
    ...
    function jg(a, b) {
        ...
        ig(a.done, c, d, e), ig(a.undone, c, d, e)
    }
    ...
    function ug(a, b) {
        ...
        if (c) {
            ...
            zc ? e = zc.delayedCallbacks : tg ? e = tg : (e = tg = [], setTimeout(vg, 0));
    ...
    function wg(a, b, c) {
        return sg(a, c || b.type, a, b), mg(b) || b.codemirrorIgnore
    }

    function xg(a) {
        var b = a._handlers && a._handlers.cursorActivity;
        if (b)for (var c = a.curOp.cursorActivityHandlers || (a.curOp.cursorActivityHandlers = []), d = 0; d < b.length; ++d)-1 == Mg(c, b[d]) && c.push(b[d])
    }
    ...
    function Tg(a, b) {
        return b ? b.source.indexOf("\\w") > -1 && Sg(a) ? !0 : b.test(a) : Sg(a)
    }
    ...
    function Wg(a) {
        return a.charCodeAt(0) >= 768 && Vg.test(a)
    }
    ...
    function dh(a, b) {
        bh(b).test(a.className) || (a.className += " " + b)
    }

    function eh(a, b) {
        for (var c = a.split(" "), d = 0; d < c.length; d++)c[d] && !bh(c[d]).test(b) && (b += " " + c[d]);
        return b
    }
    ...
    function ih() {
        var a;
        qg(window, "resize", function () {
            null == a && (a = setTimeout(function () {
                a = null, kh = null, fh(ed)
            }, 100))
        }), qg(window, "blur", function () {
            fh(Id)
        })
    }

    function lh(a) {
        if (null != kh)return kh;
        var b = Xg("div", null, null, "width: 50px; height: 50px; overflow-x: scroll");
        return $g(a, b), b.offsetWidth && (kh = b.offsetHeight - b.clientHeight), kh || 0
    }

    function nh(a) {
        if (null == mh) {
            var b = Xg("span", "\u200b");
            $g(a, Xg("span", [b, document.createTextNode("x")])), 0 != a.firstChild.offsetHeight && (mh = b.offsetWidth <= 1 && b.offsetHeight > 2 && !(d && 8 > e))
        }
        return mh ? Xg("span", "\u200b") : Xg("span", "\xa0", null, "display: inline-block; width: 1px; margin-right: -1px")
    }

    function ph(a) {
        if (null != oh)return oh;
        var b = $g(a, document.createTextNode("A\u062eA")), c = Yg(b, 0, 1).getBoundingClientRect();
        if (c.left == c.right)return !1;
        var d = Yg(b, 1, 2).getBoundingClientRect();
        return oh = d.right - c.right < 3
    }

    function uh(a) {
        if (null != th)return th;
        var b = $g(a, Xg("span", "x")), c = b.getBoundingClientRect(), d = Yg(b, 0, 1).getBoundingClientRect();
        return th = Math.abs(c.left - d.left) > 1
    }
    ...
    function Ah(a) {
        var b = Wf(a);
        return b ? yh(Kg(b)) : a.text.length
    }

    function Bh(a, b) {
        var c = Pf(a.doc, b), d = af(c);
        d != c && (b = Tf(d));
        var e = Wf(d), f = e ? e[0].level % 2 ? Ah(d) : zh(d) : 0;
        return nb(b, f)
    }

    function Ch(a, b) {
        for (var c, d = Pf(a.doc, b); c = $e(d);)d = c.find(1, !0).line, b = null;
        var e = Wf(d), f = e ? e[0].level % 2 ? zh(d) : Ah(d) : d.text.length;
        return nb(null == b ? Tf(d) : b, f)
    }

    function Dh(a, b) {
        var c = Bh(a, b.line), d = Pf(a.doc, c.line), e = Wf(d);
        if (!e || 0 == e[0].level) {
    ...
    function Gh(a, b) {
        ...
        for (var d, c = 0; c < a.length; ++c) {
            ...
            if (e.from == b || e.to == b) {
                if (null != d)return Eh(a, e.level, a[d].level) ? (e.from != e.to && (Fh = d), c) : (e.from != e.to && (Fh = c), d);
                d = c
            }
        }
        return d
    ...
    function Hh(a, b, c, d) {
        if (!d)return b + c;
        do b += c; while (b > 0 && Wg(a.text.charAt(b)));
        return b
    }

    function Ih(a, b, c, d) {
        var e = Wf(a);
        if (!e)return Jh(a, b, c, d);
        for (var f = Gh(e, b), g = e[f], h = Hh(a, b, g.level % 2 ? -c : c, d); ;) {
            if (h > g.from && h < g.to)return h;
            if (h == g.from || h == g.to)return Gh(e, h) == f ? h : (g = e[f += c], c > 0 == g.level % 2 ? g.to : g.from);
            if (g = e[f += c], !g)return null;
            h = c > 0 == g.level % 2 ? Hh(a, g.to, -1, d) : Hh(a, g.from, 1, d)
        }
    }

    function Jh(a, b, c, d) {
        var e = b + c;
        if (d)for (; e > 0 && Wg(a.text.charAt(e));)e += c;
    ...
    var wc, id, jd, gc = {
        ...
        top: 0,
        bottom: 0
    }, zc = null, Ac = 0, Zc = null, pd = 0, ud = 0, vd = null;
    d ? vd = -.53 : a ? vd = 15 : h ? vd = -.7 : j && (vd = -1 / 3);
    var zd, Cd = null, Ld = w.changeEnd = function (a) {
        return a.text ? nb(a.from.line + a.text.length - 1, Kg(a.text).length + (1 == a.text.length ? a.from.ch : 0)) : a.to
    };
    w.prototype = {
        constructor: w, focus: function () {
            ...
            (c[a] != b || "mode" == a) && (c[a] = b, ke.hasOwnProperty(a) && Lc(this, ke[a])(this, b, d))
            ...
            this.state.overlays.push({mode: c, modeSpec: a, opaque: b && b.opaque}), this.state.modeGen++, Qc(this)
        }), removeOverlay: Mc(function (a) {
            for (var b = this.state.overlays, c = 0; c < b.length; ++c) {
                var d = b[c].modeSpec;
                if (d == a || "string" == typeof a && d.name == a)return b.splice(c, 1), this.state.modeGen++, Qc(this), void 0
            }
        }), indentLine: Mc(function (a, b, c) {
            "string" != typeof b && "number" != typeof b && (b = null == b ? this.options.smartIndent ? "smart" : "prev" : b ? "add" : "subtract"), zb(this.doc, a) && de(this, a, b, c)
        }), indentSelection: Mc(function (a) {
            for (var b = this.doc.sel.ranges, c = -1, d = 0; d < b.length; d++) {
                var e = b[d];
                if (e.empty()) e.head.line > c && (de(this, e.head.line, a, !0), c = e.head.line, d == this.doc.sel.primIndex && be(this)); else {
                    ...
                    0 == f.ch && b.length == j.length && j[d].from().ch > 0 && Eb(this.doc, d, new tb(f, j[d].to()), Cg)
                }
            }
        }), getTokenAt: function (a, b) {
            var c = this.doc;
            a = xb(c, a);
            for (var d = Xb(this, a.line, b), e = this.doc.mode, f = Pf(c, a.line), g = new Ae(f.text, this.options.tabSize); g.pos < a.ch && !g.eol();) {
                g.start = g.pos;
                var h = qf(e, g, d)
            }
            ...
            a = xb(this.doc, a);
            var f, b = tf(this, Pf(this.doc, a.line)), c = 0, d = (b.length - 1) / 2, e = a.ch;
            ...
            var c = [];
            if (!re.hasOwnProperty(b))return re;
            var d = re[b], e = this.getModeAt(a);
            ...
            for (var f = 0; f < d._global.length; f++) {
                var h = d._global[f];
                h.pred(e, this) && -1 == Mg(c, h.val) && c.push(h.val)
            }
            return c
        }, getStateAfter: function (a, b) {
            var c = this.doc;
            return a = wb(c, null == a ? c.first + c.size - 1 : a), Xb(this, a + 1, b)
        }, cursorCoords: function (a, b) {
            var c, d = this.doc.sel.primary();
            return c = null == a ? d.head : "object" == typeof a ? xb(this.doc, a) : a ? d.from() : d.to(), rc(this, c, b || "page")
            ...
            return a = pc(this, {top: a, left: 0}, b || "page").top, Uf(this.doc, a + this.display.viewOffset)
        }, heightAtLine: function (a, b) {
            var c = !1, d = this.doc.first + this.doc.size - 1;
            a < this.doc.first ? a = this.doc.first : a > d && (a = d, c = !0);
            var e = Pf(this.doc, a);
            return oc(this, e, {top: 0, left: 0}, b || "page").top + (c ? this.doc.height - Vf(e) : 0)
            ...
            return ee(this.doc, a, "gutter", function (a) {
                ...
                return d[b] = c, !c && Ug(d) && (a.gutterMarkers = null), !0
            })
        }), clearGutter: Mc(function (a) {
            var b = this, c = b.doc, d = c.first;
            c.iter(function (c) {
                c.gutterMarkers && c.gutterMarkers[a] && (c.gutterMarkers[a] = null, Rc(b, d, "gutter"), Ug(c.gutterMarkers) && (c.gutterMarkers = null)), ++d
            })
        }), addLineWidget: Mc(function (a, b, c) {
            return kf(this, a, b, c)
            ...
            if ("number" == typeof a) {
                ...
                var b = a;
                if (a = Pf(this.doc, a), !a)return null
            } else {
                var b = Tf(a);
            ...
            b.style.top = g + "px", b.style.left = b.style.right = "", "right" == e ? (h = f.sizer.clientWidth - b.offsetWidth, b.style.right = "0px") : ("left" == e ? h = 0 : "middle" == e && (h = (f.sizer.clientWidth - b.offsetWidth) / 2), b.style.left = h + "px"), c && $d(this, h, g, h + b.offsetWidth, g + b.offsetHeight)
        }, triggerOnKeyDown: Mc(Dd), triggerOnKeyPress: Mc(Gd), triggerOnKeyUp: Fd, execCommand: function (a) {
            return ue.hasOwnProperty(a) ? ue[a](this) : void 0
        }, findPosH: function (a, b, c, d) {
            var e = 1;
            0 > b && (e = -1, b = -b);
            for (var f = 0, g = xb(this.doc, a); b > f && (g = ge(this.doc, g, e, c, d), !g.hitSide); ++f);
            return g
        }, moveH: Mc(function (a, b) {
            var c = this;
            c.extendSelectionsBy(function (d) {
                return c.display.shift || c.doc.extend || d.empty() ? ge(c.doc, d.head, a, b, c.options.rtlMoveVisually) : 0 > a ? d.from() : d.to()
            }, Eg)
        }), deleteH: Mc(function (a, b) {
            var c = this.doc.sel, d = this.doc;
            c.somethingSelected() ? d.replaceSelection("", null, "+delete") : fe(this, function (c) {
            ...
            for (var g = 0, h = xb(this.doc, a); b > g; ++g) {
                var i = rc(this, h, "div");
                if (null == f ? f = i.left : i.left = f, h = he(this, i, e, c), h.hitSide)break
            }
            return h
            ...
            if (d.extendSelectionsBy(function (g) {
                    ...
                    var i = he(c, h, a, b);
                    return "page" == b && g == d.sel.primary() && ae(c, null, qc(c, i, "div").top - h.top), i
                }, Eg), e.length)for (var g = 0; g < d.sel.ranges.length; g++)d.sel.ranges[g].goalColumn = e[g]
        }), toggleOverwrite: function (a) {
            (null == a || a != this.state.overwrite) && ((this.state.overwrite = !this.state.overwrite) ? dh(this.display.cursorDiv, "CodeMirror-overwrite") : ch(this.display.cursorDiv, "CodeMirror-overwrite"), sg(this, "overwriteToggle", this, this.state.overwrite))
        }, hasFocus: function () {
            return ah() == this.display.input
        }, scrollTo: Mc(function (a, b) {
            (null != a || null != b) && ce(this), null != a && (this.curOp.scrollLeft = a), null != b && (this.curOp.scrollTop = b)
        }), getScrollInfo: function () {
            var a = this.display.scroller, b = Ag;
            return {
                left: a.scrollLeft,
                top: a.scrollTop,
            ...
            if (null == a ? (a = {
                        ...
                        to: null
                            ...
                            from: a,
                            to: null
                        }), a.to || (a.to = a.from), a.margin = b || 0, null != a.from.line) ce(this), this.curOp.scrollToPos = a; else {
                var c = _d(this, Math.min(a.from.left, a.to.left), Math.min(a.from.top, a.to.top) - a.margin, Math.max(a.from.right, a.to.right), Math.max(a.from.bottom, a.to.bottom) + a.margin);
            ...
            var c = this;
            null != a && (c.display.wrapper.style.width = d(a)), null != b && (c.display.wrapper.style.height = d(b)), c.options.lineWrapping && kc(this);
            ...
            c.doc.iter(e, c.display.viewTo, function (a) {
                ...
                ++e
            }), c.curOp.forceUpdate = !0, sg(c, "refresh", this)
        }), operation: function (a) {
            return Kc(this, a)
        }, refresh: Mc(function () {
            var a = this.display.cachedTextHeight;
            Qc(this), this.curOp.forceUpdate = !0, lc(this), this.scrollTo(this.doc.scrollLeft, this.doc.scrollTop), H(this), (null == a || Math.abs(a - xc(this.display)) > .5) && C(this), sg(this, "refresh", this)
        }), swapDoc: Mc(function (a) {
            var b = this.doc;
            return b.cm = null, Of(this, a), lc(this), _c(this), this.scrollTo(a.scrollLeft, a.scrollTop), ug(this, "swapDoc", this, b), b
    ...
    var je = w.defaults = {}, ke = w.optionHandlers = {}, me = w.Init = {
        toString: function () {
            return "CodeMirror.Init"
        }
    };
    le("value", "", function (a, b) {
        a.setValue(b)
    }, !0), le("mode", null, function (a, b) {
        a.doc.modeOption = b, y(a)
    }, !0), le("indentUnit", 2, y, !0), le("indentWithTabs", !1), le("smartIndent", !0), le("tabSize", 4, function (a) {
        z(a), lc(a), Qc(a)
    }, !0), le("specialChars", /[\t\u0000-\u0019\u00ad\u200b-\u200f\u2028\u2029\ufeff]/g, function (a, b) {
        a.options.specialChars = new RegExp(b.source + (b.test("	") ? "" : "|	"), "g"), a.refresh()
    }, !0), le("specialCharPlaceholder", zf, function (a) {
        a.refresh()
    }, !0), le("electricChars", !0), le("rtlMoveVisually", !q), le("wholeLineUpdateBefore", !0), le("theme", "default", function (a) {
        E(a), F(a)
    }, !0), le("keyMap", "default", D), le("extraKeys", null), le("lineWrapping", !1, A, !0), le("gutters", [], function (a) {
        K(a.options), F(a)
    }, !0), le("fixedGutter", !0, function (a, b) {
        a.display.gutters.style.left = b ? S(a.display) + "px" : "0", a.refresh()
    }, !0), le("coverGutterNextToScrollbar", !1, N, !0), le("lineNumbers", !1, function (a) {
        K(a.options), F(a)
    }, !0), le("firstLineNumber", 1, F, !0), le("lineNumberFormatter", function (a) {
        return a
    }, F, !0), le("showCursorWhenSelecting", !1, Qb, !0), le("resetSelectionOnContextMenu", !0), le("readOnly", !1, function (a, b) {
        "nocursor" == b ? (Id(a), a.display.input.blur(), a.display.disabled = !0) : (a.display.disabled = !1, b || _c(a))
    }), le("disableInput", !1, function (a, b) {
        b || _c(a)
    }, !0), le("dragDrop", !0), le("cursorBlinkRate", 530), le("cursorScrollMargin", 0), le("cursorHeight", 1, Qb, !0), le("singleCursorHeightPerLine", !0, Qb, !0), le("workTime", 100), le("workDelay", 100), le("flattenSpans", !0, z, !0), le("addModeClass", !1, z, !0), le("pollInterval", 100), le("undoDepth", 200, function (a, b) {
        a.doc.history.undoDepth = b
    }), le("historyEventDelay", 1250), le("viewportMargin", 10, function (a) {
        a.refresh()
    }, !0), le("maxHighlightLength", 1e4, z, !0), le("moveInputWithCursor", !0, function (a, b) {
        b || (a.display.inputDiv.style.top = a.display.inputDiv.style.left = 0)
    }), le("tabindex", null, function (a, b) {
        a.display.input.tabIndex = b || ""
    }), le("autofocus", null);
    var ne = w.modes = {}, oe = w.mimeModes = {};
    w.defineMode = function (a, b) {
        ...
        if ("string" == typeof a && oe.hasOwnProperty(a)) a = oe[a]; else if (a && "string" == typeof a.name && oe.hasOwnProperty(a.name)) {
            var b = oe[a.name];
            "string" == typeof b && (b = {name: b}), a = Og(b, a), a.name = b.name
        ...
        var b = w.resolveMode(b), c = ne[b.name];
        if (!c)return w.getMode(a, "text/plain");
        var d = c(a, b);
        if (pe.hasOwnProperty(b.name)) {
            var e = pe[b.name];
    ...
    var pe = w.modeExtensions = {};
    w.extendMode = function (a, b) {
        var c = pe.hasOwnProperty(a) ? pe[a] : pe[a] = {};
        Pg(b, c)
    ...
    w.registerHelper = function (a, b, c) {
        re.hasOwnProperty(a) || (re[a] = w[a] = {_global: []}), re[a][b] = c
    }, w.registerGlobalHelper = function (a, b, c, d) {
        w.registerHelper(a, b, d), re[a]._global.push({pred: c, val: d})
    };
    var se = w.copyState = function (a, b) {
        if (b === !0)return b;
        ...
        return c
    }, te = w.startState = function (a, b, c) {
    ...
    var ue = w.commands = {
        selectAll: function (a) {
            a.setSelection(nb(a.firstLine(), 0), nb(a.lastLine()), Cg)
        }, singleSelection: function (a) {
            a.setSelection(a.getCursor("anchor"), a.getCursor("head"), Cg)
        }, killLine: function (a) {
            fe(a, function (b) {
                if (b.empty()) {
                    var c = Pf(a.doc, b.head.line).text.length;
            ...
            a.extendSelectionsBy(function (b) {
                var c = a.charCoords(b.head, "div").top + 5, d = a.coordsChar({left: 0, top: c}, "div");
                return d.ch < a.getLine(d.line).search(/\S/) ? Dh(a, b.head) : d
            }, Eg)
        }, goLineUp: function (a) {
            a.moveV(-1, "line")
            ...
            Kc(a, function () {
                for (var b = a.listSelections(), c = [], d = 0; d < b.length; d++) {
                    var e = b[d].head, f = Pf(a.doc, e.line).text;
            ...
            Kc(a, function () {
                for (var b = a.listSelections().length, c = 0; b > c; c++) {
                    ...
                    a.replaceRange("\n", d.anchor, d.head, "+input"), a.indentLine(d.from().line + 1, null, !0), be(a)
                }
            })
        }, toggleOverwrite: function (a) {
            a.toggleOverwrite()
    ...
    }, ve["default"] = p ? ve.macDefault : ve.pcDefault;
    var xe = w.lookupKey = function (a, b, c) {
        function d(b) {
            b = we(b);
            var e = b[a];
            if (e === !1)return "stop";
    ...
    }, ye = w.isModifierKey = function (a) {
        var b = vh[a.keyCode];
        return "Ctrl" == b || "Alt" == b || "Shift" == b || "Mod" == b
    }, ze = w.keyName = function (a, b) {
    ...
    w.fromTextArea = function (a, b) {
        ...
        if (a.form && (qg(a.form, "submit", d), !b.leaveSubmitMethodAlone)) {
        ...
        return i.save = d, i.getTextArea = function () {
            ...
            d(), a.parentNode.removeChild(i.getWrapperElement()), a.style.display = "", a.form && (rg(a.form, "submit", d), "function" == typeof a.form.submit && (a.form.submit = f))
        }, i
    };
    var Ae = w.StringStream = function (a, b) {
    ...
    var Be = w.TextMarker = function (a, b) {
        this.lines = [], this.type = b, this.doc = a
    };
    zg(Be), Be.prototype.clear = function () {
        if (!this.explicitlyCleared) {
            var a = this.doc.cm, b = a && !a.curOp;
            if (b && Bc(a), yg(this, "clear")) {
                var c = this.find();
                c && ug(this, "clear", c.from, c.to)
            }
            for (var d = null, e = null, f = 0; f < this.lines.length; ++f) {
                var g = this.lines[f], h = Ke(g.markedSpans, this);
                a && !this.collapsed ? Rc(a, Tf(g), "text") : a && (null != h.to && (e = Tf(g)), null != h.from && (d = Tf(g))), g.markedSpans = Le(g.markedSpans, h), null == h.from && this.collapsed && !ef(this.doc, g) && a && Sf(g, xc(a.display))
            }
            if (a && this.collapsed && !a.options.lineWrapping)for (var f = 0; f < this.lines.length; ++f) {
                var i = af(this.lines[f]), j = I(i);
                j > a.display.maxLineLength && (a.display.maxLine = i, a.display.maxLineLength = j, a.display.maxLineChanged = !0)
            }
            null != d && a && this.collapsed && Qc(a, d, e + 1), this.lines.length = 0, this.explicitlyCleared = !0, this.atomic && this.doc.cantEdit && (this.doc.cantEdit = !1, a && Lb(a.doc)), a && ug(a, "markerCleared", a, this), b && Dc(a), this.parent && this.parent.clear()
        }
    }, Be.prototype.find = function (a, b) {
        null == a && "bookmark" == this.type && (a = 1);
        for (var c, d, e = 0; e < this.lines.length; ++e) {
            var f = this.lines[e], g = Ke(f.markedSpans, this);
            if (null != g.from && (c = nb(b ? f : Tf(f), g.from), -1 == a))return c;
            if (null != g.to && (d = nb(b ? f : Tf(f), g.to), 1 == a))return d
        }
        return c && {from: c, to: d}
    }, Be.prototype.changed = function () {
        var a = this.find(-1, !0), b = this, c = this.doc.cm;
        a && c && Kc(c, function () {
            var d = a.line, e = Tf(a.line), f = dc(c, e);
            if (f && (jc(f), c.curOp.selectionChanged = c.curOp.forceUpdate = !0), c.curOp.updateMaxLine = !0, !ef(b.doc, d) && null != b.height) {
                var g = b.height;
                b.height = null;
                var h = jf(b) - g;
                h && Sf(d, d.height + h)
    ...
    }, Be.prototype.attachLine = function (a) {
        if (!this.lines.length && this.doc.cm) {
            var b = this.doc.cm.curOp;
            b.maybeHiddenMarkers && -1 != Mg(b.maybeHiddenMarkers, this) || (b.maybeUnhiddenMarkers || (b.maybeUnhiddenMarkers = [])).push(this)
        }
        this.lines.push(a)
    }, Be.prototype.detachLine = function (a) {
        if (this.lines.splice(Mg(this.lines, a), 1), !this.lines.length && this.doc.cm) {
            var b = this.doc.cm.curOp;
            (b.maybeHiddenMarkers || (b.maybeHiddenMarkers = [])).push(this)
        }
    };
    var Ce = 0, Ee = w.SharedTextMarker = function (a, b) {
        this.markers = a, this.primary = b;
        for (var c = 0; c < a.length; ++c)a[c].parent = this
    };
    zg(Ee), Ee.prototype.clear = function () {
        if (!this.explicitlyCleared) {
            this.explicitlyCleared = !0;
            for (var a = 0; a < this.markers.length; ++a)this.markers[a].clear();
            ug(this, "clear")
        }
    }, Ee.prototype.find = function (a, b) {
        return this.primary.find(a, b)
    };
    var gf = w.LineWidget = function (a, b, c) {
        if (c)for (var d in c)c.hasOwnProperty(d) && (this[d] = c[d]);
        this.cm = a, this.node = b
    };
    zg(gf), gf.prototype.clear = function () {
        var a = this.cm, b = this.line.widgets, c = this.line, d = Tf(c);
        if (null != d && b) {
            for (var e = 0; e < b.length; ++e)b[e] == this && b.splice(e--, 1);
            b.length || (c.widgets = null);
            var f = jf(this);
            Kc(a, function () {
                hf(a, c, -f), Rc(a, d, "widget"), Sf(c, Math.max(0, c.height - f))
            })
        }
    }, gf.prototype.changed = function () {
        var a = this.height, b = this.cm, c = this.line;
        this.height = null;
        var d = jf(this) - a;
        d && Kc(b, function () {
            b.curOp.forceUpdate = !0, hf(b, c, d), Sf(c, c.height + d)
        })
    };
    var lf = w.Line = function (a, b, c) {
        this.text = a, Ue(this, b), this.height = c ? c(this) : 1
    };
    zg(lf), lf.prototype.lineNo = function () {
        return Tf(this)
    };
    var vf = {}, wf = {};
    Hf.prototype = {
        chunkSize: function () {
            ...
            for (var c = a, d = a + b; d > c; ++c) {
                var e = this.lines[c];
                this.height -= e.height, nf(e), ug(e, "delete")
            }
        ...
        chunkSize: function () {
            ...
            if (this.size - b < 25 && (this.children.length > 1 || !(this.children[0] instanceof Hf))) {
                var h = [];
                this.collapse(h), this.children = [new Hf(h)], this.children[0].parent = this
            }
        }, collapse: function (a) {
                ...
                if (f >= a) {
                    if (e.insertInner(a, b, c), e.lines && e.lines.length > 50) {
                        for (; e.lines.length > 50;) {
                            var g = e.lines.splice(e.lines.length - 25, 25), h = new Hf(g);
            ...
            if (!(this.children.length <= 10)) {
                var a = this;
                do {
                    var b = a.children.splice(a.children.length - 5, 5), c = new If(b);
                    if (a.parent) {
                        a.size -= c.size, a.height -= c.height;
                        var e = Mg(a.parent.children, a);
                        a.parent.children.splice(e + 1, 0, c)
                    } else {
                        var d = new If(a.children);
    ...
    var Jf = 0, Kf = w.Doc = function (a, b, c) {
        if (!(this instanceof Kf))return new Kf(a, b, c);
        null == c && (c = 0), If.call(this, [new Hf([new lf("", null)])]), this.first = c, this.scrollTop = this.scrollLeft = 0, this.cantEdit = !1, this.cleanGeneration = 1, this.frontier = c;
        var d = nb(c, 0);
        this.sel = vb(d), this.history = new Xf(null), this.id = ++Jf, this.modeOption = b, "string" == typeof a && (a = qh(a)), Gf(this, {
            from: d,
            to: d,
            text: a
        }), Ib(this, vb(d), Cg)
    };
    Kf.prototype = Og(If.prototype, {
        constructor: Kf, iter: function (a, b, c) {
            ...
            Db(this, Ng(this.sel.ranges, a), b)
            ...
            for (var d = [], e = this.sel, f = 0; f < e.ranges.length; f++) {
                var g = e.ranges[f];
                d[f] = {from: g.from(), to: g.to(), text: qh(a[f]), origin: c}
            }
            for (var h = b && "end" != b && Pd(this, d, b), f = d.length - 1; f >= 0; f--)Rd(this, d[f]);
            ...
            this.history = new Xf(this.history.maxGeneration)
        }, markClean: function () {
            ...
            return {done: gg(this.history.done), undone: gg(this.history.undone)}
        }, setHistory: function (a) {
            var b = this.history = new Xf(this.history.maxGeneration);
            b.done = gg(a.done.slice(0), null, !0), b.undone = gg(a.undone.slice(0), null, !0)
            ...
            return De(this, xb(this, a), xb(this, b), c, "range")
            ...
            return a = xb(this, a), De(this, a, a, c, "bookmark")
        }, findMarksAt: function (a) {
            a = xb(this, a);
            var b = [], c = Pf(this, a.line).markedSpans;
            ...
            var b = new Kf(Rf(this, this.first, this.first + this.size), this.modeOption, this.first);
            ...
            if (a.history == this.history) {
                ...
                Nf(a, function (a) {
                    d.push(a.id)
                }, !0), a.history = new Xf(null), a.history.done = gg(this.history.done, d), a.history.undone = gg(this.history.undone, d)
            }
    ...
    }), Kf.prototype.eachLine = Kf.prototype.iter;
    var Lf = "iter insert remove copy getEditor".split(" ");
    for (var Mf in Kf.prototype)Kf.prototype.hasOwnProperty(Mf) && Mg(Lf, Mf) < 0 && (w.prototype[Mf] = function (a) {
        return function () {
            return a.apply(this.doc, arguments)
        }
    }(Kf.prototype[Mf]));
    zg(Kf);
    var kg = w.e_preventDefault = function (a) {
        a.preventDefault ? a.preventDefault() : a.returnValue = !1
    }, lg = w.e_stopPropagation = function (a) {
        a.stopPropagation ? a.stopPropagation() : a.cancelBubble = !0
    }, ng = w.e_stop = function (a) {
        kg(a), lg(a)
    }, qg = w.on = function (a, b, c) {
    ...
    n ? Lg = function (a) {
        ...
        }), [].indexOf && (Mg = function (a, b) {
        return a.indexOf(b)
    }), [].map && (Ng = function (a, b) {
        return a.map(b)
    });
    var Yg, Rg = /[\u00df\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/, Sg = w.isWordChar = function (a) {
        return /\w/.test(a) || a > "\x80" && (a.toUpperCase() != a.toLowerCase() || Rg.test(a))
    }, Vg = /[\u0300-\u036f\u0483-\u0489\u0591-\u05bd\u05bf\u05c1\u05c2\u05c4\u05c5\u05c7\u0610-\u061a\u064b-\u065e\u0670\u06d6-\u06dc\u06de-\u06e4\u06e7\u06e8\u06ea-\u06ed\u0711\u0730-\u074a\u07a6-\u07b0\u07eb-\u07f3\u0816-\u0819\u081b-\u0823\u0825-\u0827\u0829-\u082d\u0900-\u0902\u093c\u0941-\u0948\u094d\u0951-\u0955\u0962\u0963\u0981\u09bc\u09be\u09c1-\u09c4\u09cd\u09d7\u09e2\u09e3\u0a01\u0a02\u0a3c\u0a41\u0a42\u0a47\u0a48\u0a4b-\u0a4d\u0a51\u0a70\u0a71\u0a75\u0a81\u0a82\u0abc\u0ac1-\u0ac5\u0ac7\u0ac8\u0acd\u0ae2\u0ae3\u0b01\u0b3c\u0b3e\u0b3f\u0b41-\u0b44\u0b4d\u0b56\u0b57\u0b62\u0b63\u0b82\u0bbe\u0bc0\u0bcd\u0bd7\u0c3e-\u0c40\u0c46-\u0c48\u0c4a-\u0c4d\u0c55\u0c56\u0c62\u0c63\u0cbc\u0cbf\u0cc2\u0cc6\u0ccc\u0ccd\u0cd5\u0cd6\u0ce2\u0ce3\u0d3e\u0d41-\u0d44\u0d4d\u0d57\u0d62\u0d63\u0dca\u0dcf\u0dd2-\u0dd4\u0dd6\u0ddf\u0e31\u0e34-\u0e3a\u0e47-\u0e4e\u0eb1\u0eb4-\u0eb9\u0ebb\u0ebc\u0ec8-\u0ecd\u0f18\u0f19\u0f35\u0f37\u0f39\u0f71-\u0f7e\u0f80-\u0f84\u0f86\u0f87\u0f90-\u0f97\u0f99-\u0fbc\u0fc6\u102d-\u1030\u1032-\u1037\u1039\u103a\u103d\u103e\u1058\u1059\u105e-\u1060\u1071-\u1074\u1082\u1085\u1086\u108d\u109d\u135f\u1712-\u1714\u1732-\u1734\u1752\u1753\u1772\u1773\u17b7-\u17bd\u17c6\u17c9-\u17d3\u17dd\u180b-\u180d\u18a9\u1920-\u1922\u1927\u1928\u1932\u1939-\u193b\u1a17\u1a18\u1a56\u1a58-\u1a5e\u1a60\u1a62\u1a65-\u1a6c\u1a73-\u1a7c\u1a7f\u1b00-\u1b03\u1b34\u1b36-\u1b3a\u1b3c\u1b42\u1b6b-\u1b73\u1b80\u1b81\u1ba2-\u1ba5\u1ba8\u1ba9\u1c2c-\u1c33\u1c36\u1c37\u1cd0-\u1cd2\u1cd4-\u1ce0\u1ce2-\u1ce8\u1ced\u1dc0-\u1de6\u1dfd-\u1dff\u200c\u200d\u20d0-\u20f0\u2cef-\u2cf1\u2de0-\u2dff\u302a-\u302f\u3099\u309a\ua66f-\ua672\ua67c\ua67d\ua6f0\ua6f1\ua802\ua806\ua80b\ua825\ua826\ua8c4\ua8e0-\ua8f1\ua926-\ua92d\ua947-\ua951\ua980-\ua982\ua9b3\ua9b6-\ua9b9\ua9bc\uaa29-\uaa2e\uaa31\uaa32\uaa35\uaa36\uaa43\uaa4c\uaab0\uaab2-\uaab4\uaab7\uaab8\uaabe\uaabf\uaac1\uabe5\uabe8\uabed\udc00-\udfff\ufb1e\ufe00-\ufe0f\ufe20-\ufe26\uff9e\uff9f]/;
    Yg = document.createRange ? function (a, b, c) {
    ...
    w.keyNames = vh, function () {
        for (var a = 0; 10 > a; a++)vh[a + 48] = vh[a + 96] = String(a);
        for (var a = 65; 90 >= a; a++)vh[a] = String.fromCharCode(a);
        for (var a = 1; 12 >= a; a++)vh[a + 111] = vh[a + 63235] = "F" + a
    }();
    var Fh, Kh = function () {
        function c(c) {
        ...
        return function (a) {
            ...
            return 1 == u[0].level && (v = a.match(/^\s+/)) && (u[0].from = v[0].length, u.unshift(new j(0, 0, v[0].length))), 1 == Kg(u).level && (v = a.match(/\s+$/)) && (Kg(u).to -= v[0].length, u.push(new j(0, b - v[0].length, b))), u[0].level != Kg(u).level && u.push(new j(u[0].level, b, b)), u
        }
    }();
    return w.version = "4.5.0", w
}), function (a) {
